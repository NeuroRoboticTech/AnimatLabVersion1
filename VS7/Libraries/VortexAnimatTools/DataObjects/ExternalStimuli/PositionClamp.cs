...
namespace VortexAnimatTools.DataObjects.ExternalStimuli
{
	...
	/// </summary>
	public class PositionClamp : AnimatTools.DataObjects.ExternalStimuli.BodyPartStimulus
	{
		#region Attributes
		...
		protected AnimatTools.Framework.ScaledNumber m_snPosition;
		...
		public override String ImageName {get{return "VortexAnimatTools.Graphics.PositionClamp_Large.gif";}}
		public override String TypeName {get{return "Position Clamp";}}
		public override String Description {get{return "This Allows you to apply feedback regulated force to maintain a joint position.";}}
		public override String StimulusClassType {get{return "PositionClamp";}}
		...
		public virtual AnimatTools.Framework.ScaledNumber Position
		{
			get{return m_snPosition;}
			set 
			{
				m_snPosition.CopyData(ref value);
			}
		}
		...
		public PositionClamp(AnimatTools.Framework.DataObject doParent) : base(doParent)
		{
			...
			m_snPosition = new AnimatTools.Framework.ScaledNumber(this, "Position", 0, AnimatTools.Framework.ScaledNumber.enumNumericScale.None, "meters", "m");
			...
			m_thDataTypes.DataTypes.Add(new AnimatTools.DataObjects.DataType("Position", "Position", "m", "m", 0, 1000));
			m_thDataTypes.DataTypes.Add(new AnimatTools.DataObjects.DataType("Velocity", "Velocity", "m/s", "m/s", 0, 1000));
		...
		protected override void BuildProperties()
		{
			...
			Crownwood.Magic.Controls.PropertyBag pbNumberBag = m_snPosition.Properties;
			m_Properties.Properties.Add(new Crownwood.Magic.Controls.PropertySpec("Position", pbNumberBag.GetType(), "Position", 
										"Clamp Properties", "The position that should be maintained.", pbNumberBag, 
		...
		protected override void CloneInternal(AnimatTools.Framework.DataObject doOriginal, bool bCutData, AnimatTools.Framework.DataObject doRoot)
		{
			...
			PositionClamp doOrigBody = (PositionClamp) doOriginal;
			...
			m_snPosition = (AnimatTools.Framework.ScaledNumber) doOrigBody.m_snPosition.Clone(this, bCutData, doRoot);
		...
		{
			PositionClamp bnPart = new PositionClamp(doParent);
		...
		{
			double dblActualValue = m_snPosition.ActualValue;
			AnimatTools.Framework.ScaledNumber.enumNumericScale eScale =  m_snPosition.Scale;
			...
			{	
				...
				if(doJoint.UsesRadians) 
					m_snPosition = new AnimatTools.Framework.ScaledNumber(this, "Position", 0, AnimatTools.Framework.ScaledNumber.enumNumericScale.None, "radians", "rad");
				else
					m_snPosition = new AnimatTools.Framework.ScaledNumber(this, "Position", 0, AnimatTools.Framework.ScaledNumber.enumNumericScale.None, "meters", "m");
			}
			else
			...
			m_snPosition.SetFromValue(dblActualValue, eScale);
		}
		...
		public override void SaveXml(ref AnimatTools.Interfaces.StdXml oXml)
		{
				...
				m_thSecondaryAttachment != null && m_thSecondaryAttachment.BodyPart != null)
			{
				...
				oXml.AddChildElement("UsePosition", true);
				oXml.AddChildElement("Position", m_snPosition.ActualValue);
		...
		public override void LoadData(ref AnimatTools.Interfaces.StdXml oXml)
		{
			...
			m_snPosition.LoadData(ref oXml, "Position");
		...
		public override void SaveData(ref AnimatTools.Interfaces.StdXml oXml)
		{
			...
			m_snPosition.SaveData(ref oXml, "Position");
