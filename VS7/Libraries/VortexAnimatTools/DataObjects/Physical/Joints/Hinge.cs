...
namespace VortexAnimatTools.DataObjects.Physical.Joints
{
	...
	public class Hinge : VortexAnimatTools.DataObjects.Physical.Joints.Joint_DX
	{
		...
		public override System.Type PartType {get{return typeof(VortexAnimatTools.DataObjects.Physical.Joints.Hinge);}}
...
//					throw new System.Exception("The constraint rotation value must be between -180 and 180 degrees.");
		...
		protected override void CloneInternal(AnimatTools.Framework.DataObject doOriginal, bool bCutData, AnimatTools.Framework.DataObject doRoot)
		{
			...
			m_snMinAngle = (AnimatTools.Framework.ScaledNumber) m_snMinAngle.Clone(this, bCutData, doRoot);
			m_snMaxAngle = (AnimatTools.Framework.ScaledNumber) m_snMaxAngle.Clone(this, bCutData, doRoot);
			m_bEnableMotor = doOrigBody.m_bEnableMotor;
			m_bServoMotor = doOrigBody.m_bServoMotor;
			m_fltServoGain = doOrigBody.ServoGain;
			m_snMaxTorque = (AnimatTools.Framework.ScaledNumber) m_snMaxTorque.Clone(this, bCutData, doRoot);
