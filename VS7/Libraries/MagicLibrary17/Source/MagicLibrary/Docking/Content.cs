    ...
    public class Content
    {
        ...
        public enum Property
        {
            ...
            DisplayLocation
				...
				protected bool _backgroundForm;
        ...
        public string Title
        {
            ...
            set 
            {
                if (_title != value)
                {
                    ...
                    _title = value;
										if(_tabTitle.Length == 0) _tabTitle = _title;
      ...
      string attrDisplaySize = xmlIn.GetAttribute(6);
			...
			string attrFullTitle = xmlIn.GetAttribute(10);
