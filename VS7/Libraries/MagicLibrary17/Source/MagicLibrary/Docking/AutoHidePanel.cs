    ...
    public class AutoHidePanel : Panel, IMessageFilter
	{
        ...
        public void BringContentIntoView(Content c)
        {
            ...
            foreach(TabStub ts in this.Controls)
            {
				...
				public void RestoreToHiddenState()
				{
					if(_slideOut && _currentPanel != null && !_currentPanel.IsDisposed && _currentWCT != null && !_currentWCT.IsDisposed)
					{
						_slideOut = false;
						StartSlideTimer();
					}
...
//                _slideRect.Height = availableSize.Height;
        ...
        protected void OnSlideTick(object sender, EventArgs e)
        {
            ...
            {            
                ...
                if (this.IsDisposed || _currentPanel == null || _currentPanel.IsDisposed || _currentWCT == null || _currentWCT.IsDisposed)
                {
                    StopSlideTimer();
                    return;
                }
