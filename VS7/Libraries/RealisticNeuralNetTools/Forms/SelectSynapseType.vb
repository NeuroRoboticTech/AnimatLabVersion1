...
#Region " Attributes "
        ...
        Protected m_blSelectedLink As AnimatTools.DataObjects.Behavior.Link
        Protected m_stSelectedSynapseType As DataObjects.Behavior.SynapseType
        Protected m_bnOrigin As AnimatTools.DataObjects.Behavior.Node
        Protected m_bnDestination As AnimatTools.DataObjects.Behavior.Node
        Protected m_aryCompatibleLinks As AnimatTools.Collections.Links
        Protected m_mgrIconImages As AnimatTools.Framework.ImageManager
...
#Region " Properties "
        ...
        Public Property SelectedLink() As AnimatTools.DataObjects.Behavior.Link
            Get
        ...
        Public Property Origin() As AnimatTools.DataObjects.Behavior.Node
            Get
                Return m_bnOrigin
            End Get
        ...
        Public Property Destination() As AnimatTools.DataObjects.Behavior.Node
            Get
        ...
        Public Property CompatibleLinks() As AnimatTools.Collections.Links
            Get
                Return m_aryCompatibleLinks
            End Get
            Set(ByVal Value As AnimatTools.Collections.Links)
...
#Region " Events "
        ...
        Protected Sub OnCloneSynapseType(ByVal sender As Object, ByVal e As System.EventArgs)
            ...
            Try
                ...
                m_nmNeuralModule.SynapseTypes.Add(stNewType.ID, stNewType)
        ...
        Protected Sub OnNewSynapseType(ByVal sender As Object, ByVal e As System.EventArgs)
            ...
            Try
                ...
                End If
                stNewType.Name = "New Synapse Type"
                stNewType.NeuralModule = m_nmNeuralModule
            ...
            Try
                ...
                If frmDelete.ShowDialog = DialogResult.OK AndAlso Not frmDelete.m_doTypeToReplace Is Nothing Then
                    ...
                    If Not Me.NeuralModule.Organism Is Nothing Then
                        ...
                        Dim doSynapse As RealisticNeuralNetTools.DataObjects.Behavior.Synapse
                        For Each deEntry As DictionaryEntry In Me.NeuralModule.Organism.BehavioralLinks
                            If TypeOf deEntry.Value Is RealisticNeuralNetTools.DataObjects.Behavior.Synapse Then
                                doSynapse = DirectCast(deEntry.Value, RealisticNeuralNetTools.DataObjects.Behavior.Synapse)
