...
Namespace Forms.Behavior
    ...
    Public Class AddFlowDiagram
        Inherits AnimatTools.Forms.Behavior.Diagram
...
#Region " Properties "
        ...
        Public Overrides ReadOnly Property IconName() As String
            Get
                Return "LicensedAnimatTools.SubsystemNode.gif"
            End Get
        End Property
...
#Region " Methods "
        ...
        Public Overrides Sub Initialize(ByRef frmApplication As AnimatApplication, _
            ...
            Try
                ...
                m_bnParentDiagram = DirectCast(frmParent, AnimatTools.Forms.Behavior.Diagram)

                Dim myAssembly As System.Reflection.Assembly
                myAssembly = System.Reflection.Assembly.Load("AnimatTools")

                Me.Icon = m_frmApplication.SmallImages.LoadIcon(myAssembly, "AnimatTools.DataGraph.ico")
        ...
        Protected Sub UpdateAddFlowNode(ByRef afNode As Lassalle.Flow.Node, _
                                        ByRef bdNode As AnimatTools.DataObjects.Behavior.Node, _
        ...
        Protected Sub UpdateBehavioralNode(ByRef afNode As Lassalle.Flow.Node, _
            ...
            If Not bSimple Then
                bdNode.Alignment = CType(afNode.Alignment, AnimatTools.DataObjects.Behavior.Node.enumAlignment)
                bdNode.AutoSize = CType(afNode.AutoSize, AnimatTools.DataObjects.Behavior.Node.enumAutoSize)
                bdNode.BackMode = CType(afNode.BackMode, AnimatTools.DataObjects.Behavior.Node.enumBackmode)
                ...
                bdNode.ImagePosition = CType(afNode.ImagePosition, AnimatTools.DataObjects.Behavior.Node.enumImagePosition)
                bdNode.InLinkable = afNode.InLinkable
                bdNode.LabelEdit = afNode.LabelEdit
                bdNode.OutLinkable = afNode.OutLinkable
                bdNode.ShadowStyle = CType(afNode.Shadow.Style, AnimatTools.DataObjects.Behavior.Node.enumShadow)
                bdNode.ShadowColor = afNode.Shadow.Color
                bdNode.ShadowSize = afNode.Shadow.Size
                bdNode.Shape = CType(afNode.Shape.Style, AnimatTools.DataObjects.Behavior.Node.enumShape)
                bdNode.ShapeOrientation = CType(afNode.Shape.Orientation, AnimatTools.DataObjects.Behavior.Node.enumShapeOrientation)
        ...
        Public Overrides Function FindNode(ByVal strID As String, Optional ByVal bThrowError As Boolean = True) As AnimatTools.DataObjects.Behavior.Node
        ...
        Public Overrides Function FindLink(ByVal strID As String, Optional ByVal bThrowError As Boolean = True) As AnimatTools.DataObjects.Behavior.Link
        ...
        Public Overrides Function FindItem(ByVal strID As String, Optional ByVal bThrowError As Boolean = True) As AnimatTools.DataObjects.Behavior.Data
            Dim bdData As AnimatTools.DataObjects.Behavior.Data = FindNode(strID, False)
        ...
        Public Overrides Sub AddNode(ByRef bdNode As AnimatTools.DataObjects.Behavior.Node)
            ...
            m_aryNodes.Add(bdNode.ID, bdNode)
        ...
        Public Overrides Sub BeginEditNode(ByRef bnNode As AnimatTools.DataObjects.Behavior.Node)
            Dim afNode As Lassalle.Flow.Node = FindAddFlowNode(bnNode.ID)
            afNode.BeginEdit()
        End Sub

        Public Overrides Sub EndEditNode(ByRef bnNode As AnimatTools.DataObjects.Behavior.Node, ByVal bCancel As Boolean)
            Dim afNode As Lassalle.Flow.Node = FindAddFlowNode(bnNode.ID)
            afNode.EndEdit(bCancel)
        End Sub

        Public Overrides Sub RemoveNode(ByRef bnNode As AnimatTools.DataObjects.Behavior.Node)
            ...
            Try
                ...
                For Each strID As String In aryLinkIDs
                    blLink = DirectCast(bnNode.Links(strID), AnimatTools.DataObjects.Behavior.Link)
                    RemoveLink(blLink)
                Next

                bnNode.BeforeRemoveNode()
                m_aryAddFlowNodes.Remove(bnNode.ID)
                m_aryNodes.Remove(bnNode.ID)
        ...
        Public Overrides Function GetChartItemAt(ByVal ptPosition As Point, Optional ByVal bThrowError As Boolean = True) As AnimatTools.DataObjects.Behavior.Data
        ...
        Public Overrides Sub AddLink(ByRef bnOrigin As AnimatTools.DataObjects.Behavior.Node, ByRef bnDestination As AnimatTools.DataObjects.Behavior.Node, ByRef blLink As AnimatTools.DataObjects.Behavior.Link)
        ...
        Public Overrides Sub RemoveLink(ByRef blLink As AnimatTools.DataObjects.Behavior.Link)
        ...
        Protected Overridable Overloads Sub AddToOrganism(ByVal blLink As AnimatTools.DataObjects.Behavior.Link)
        ...
        Protected Overridable Overloads Sub RemoveFromOrganism(ByVal blLink As AnimatTools.DataObjects.Behavior.Link)
        ...
        Protected Overridable Overloads Sub AddToOrganism(ByVal bnNode As AnimatTools.DataObjects.Behavior.Node)
        ...
        Protected Overridable Overloads Sub RemoveFromOrganism(ByVal bnNode As AnimatTools.DataObjects.Behavior.Node)
        ...
        Public Overrides Sub UpdateChart(ByRef bdData As AnimatTools.DataObjects.Behavior.Data)
            If TypeOf (bdData) Is AnimatTools.DataObjects.Behavior.Node Then
                Dim afNode As Lassalle.Flow.Node = FindAddFlowNode(bdData.ID, False)
                If Not afNode Is Nothing Then
                    UpdateAddFlowNode(afNode, DirectCast(bdData, AnimatTools.DataObjects.Behavior.Node))
                Else
                    Dim iVal As Integer = 5
                End If
            ElseIf TypeOf (bdData) Is AnimatTools.DataObjects.Behavior.Link Then
                Dim afLink As Lassalle.Flow.Link = FindAddFlowLink(bdData.ID.ToLower, False)
                If Not afLink Is Nothing Then
                    UpdateAddFlowLink(afLink, DirectCast(bdData, AnimatTools.DataObjects.Behavior.Link))
                End If
            End If
        End Sub

        Public Overrides Sub UpdateData(ByRef bdData As AnimatTools.DataObjects.Behavior.Data, Optional ByVal bSimple As Boolean = True, Optional ByVal bThrowError As Boolean = True)
            If TypeOf (bdData) Is AnimatTools.DataObjects.Behavior.Node Then
                Dim afNode As Lassalle.Flow.Node = FindAddFlowNode(bdData.ID, bThrowError)

                If Not afNode Is Nothing Then
                    UpdateBehavioralNode(afNode, DirectCast(bdData, AnimatTools.DataObjects.Behavior.Node), False, bSimple)
        ...
        Public Overrides Sub SelectDataItem(ByVal bdItem As AnimatTools.DataObjects.Behavior.Data, Optional ByVal bOnlyItemSelected As Boolean = True)
        ...
        Public Overrides Function IsItemSelected(ByVal bdItem As AnimatTools.DataObjects.Behavior.Data) As Boolean
            Dim afItem As Lassalle.Flow.Item = Me.FindAddFlowItem(bdItem.ID)
        ...
        Public Overrides Sub TabSelected()
            ...
            If Not (item Is Nothing) Then
                Dim bdItem As AnimatTools.DataObjects.Behavior.Data = FindItem(DirectCast(item.Tag, String))
        ...
        Public Overrides Sub AddImage(ByRef diImage As AnimatTools.DataObjects.Behavior.DiagramImage)
            If Not m_ctrlAddFlow.Images.Contains(diImage.Image) Then
                m_ctrlAddFlow.Images.Add(diImage.Image)
            End If

            'Now add it to any subdiagrams
            Dim doDiagram As AnimatTools.Forms.Behavior.Diagram
            For Each deEntry As DictionaryEntry In Me.Diagrams
                doDiagram = DirectCast(deEntry.Value, AnimatTools.Forms.Behavior.Diagram)
                doDiagram.AddImage(diImage)
            Next

        End Sub

        Public Overrides Sub RemoveImage(ByRef diImage As AnimatTools.DataObjects.Behavior.DiagramImage)
            If m_ctrlAddFlow.Images.Contains(diImage.Image) Then
                m_ctrlAddFlow.Images.Remove(diImage.Image)
            End If
        ...
        Public Overrides Function ImageUseCount(ByVal diImage As AnimatTools.DataObjects.Behavior.DiagramImage) As Integer
            ...
            For Each deEntry As DictionaryEntry In m_aryDiagrams
                bdDiagram = DirectCast(deEntry.Value, AnimatTools.Forms.Behavior.Diagram)
        ...
        Public Overrides Sub SetItemsTempID(ByVal bdItem As AnimatTools.DataObjects.Behavior.Data, ByVal strId As String)
...
#Region " Undo/Redo Synchronization "
            ...
            For Each afNode As Lassalle.Flow.Node In m_ctrlAddFlow.Nodes
                If m_aryNodes(DirectCast(afNode.Tag, String)) Is Nothing Then
                    ...
                    If Not m_aryDeletedNodes(DirectCast(afNode.Tag, String)) Is Nothing Then
                        bnNode = DirectCast(m_aryDeletedNodes(DirectCast(afNode.Tag, String)), AnimatTools.DataObjects.Behavior.Node)
        ...
        Protected Overridable Sub SynchronizeRemovedNodes()
            ...
            For iIndex As Integer = 0 To iCount
                bnNode = DirectCast(m_aryNodes.GetByIndex(iIndex), AnimatTools.DataObjects.Behavior.Node)
                bnNode.Found = False
            Next
            ...
            For Each oNode As Object In aryRemove
                bnNode = DirectCast(oNode, AnimatTools.DataObjects.Behavior.Node)
                ...
                For Each afLink As Lassalle.Flow.Link In afNode.OutLinks
                    If m_aryLinks(DirectCast(afLink.Tag, String)) Is Nothing Then
                        ...
                        If Not m_aryDeletedLinks(DirectCast(afLink.Tag, String)) Is Nothing Then
                            Dim blLink As AnimatTools.DataObjects.Behavior.Link = DirectCast(m_aryDeletedLinks(DirectCast(afLink.Tag, String)), AnimatTools.DataObjects.Behavior.Link)
        ...
        Protected Overridable Sub SynchronizeRemovedLinks()
            ...
            For iIndex As Integer = 0 To iCount
                blLink = DirectCast(m_aryLinks.GetByIndex(iIndex), AnimatTools.DataObjects.Behavior.Link)
                blLink.Found = False
            Next
            ...
            For Each oLink As Object In aryRemove
                blLink = DirectCast(oLink, AnimatTools.DataObjects.Behavior.Link)
...
#Region " Copy/Paste Methods "
            ...
            Try
                If m_ctrlAddFlow.SelectedItems.Count > 0 Then
                    ...
                    For Each afItem In aryItems
                        ...
                        If TypeOf (afItem) Is Lassalle.Flow.Node Then
                            Dim bdNode As AnimatTools.DataObjects.Behavior.Node = FindNode(DirectCast(afItem.Tag, String), False)
                            If Not bdNode Is Nothing Then
                                RemoveNode(bdNode)
                            End If
                        ElseIf TypeOf (afItem) Is Lassalle.Flow.Link Then
                            Dim blLink As AnimatTools.DataObjects.Behavior.Link = FindLink(DirectCast(afItem.Tag, String), False)
                            If Not blLink Is Nothing Then
                                RemoveLink(blLink)
                            End If
                        End If
        ...
        Public Overrides Sub Delete()
            ...
            Try
                ...
                'Lets go through and get a list a seperate list of the selected items 
                'so we can use it. otherwise it may change while we are deleting.
                Dim aryTempNodes As AnimatTools.Collections.AnimatSortedList = m_aryNodes.Copy()

                Dim bdNode As AnimatTools.DataObjects.Behavior.Node
                For Each deEntry As DictionaryEntry In aryTempNodes
                    bdNode = DirectCast(deEntry.Value, AnimatTools.DataObjects.Behavior.Node)
                    RemoveNode(bdNode)
                Next

                Dim aryTempLinks As AnimatTools.Collections.AnimatSortedList = m_aryLinks.Copy()

                Dim bdLink As AnimatTools.DataObjects.Behavior.Link
                For Each deEntry As DictionaryEntry In aryTempLinks
                    bdLink = DirectCast(deEntry.Value, AnimatTools.DataObjects.Behavior.Link)
                    RemoveLink(bdLink)
                Next
...
#End Region
        ...
        Public Overrides Sub OnUndo()
            If m_ctrlAddFlow.CanUndo Then
                ...
                If Not m_beEditor.SelectedObject Is Nothing AndAlso TypeOf m_beEditor.SelectedObject Is AnimatTools.DataObjects.Behavior.Data Then
                    Dim bdData As AnimatTools.DataObjects.Behavior.Data = DirectCast(m_beEditor.SelectedObject, AnimatTools.DataObjects.Behavior.Data)
        ...
        Protected Function FindHalfwayLocation(ByVal bnOrigin As AnimatTools.DataObjects.Behavior.Node, _
                                               ByVal bnDestination As AnimatTools.DataObjects.Behavior.Node, _
        ...
        Protected Overrides Sub BuildProperties()
            ...
            m_Properties.Properties.Add(New Crownwood.Magic.Controls.PropertySpec("Draw Grid", GetType(Boolean), "DrawGrid", _
                                        "Diagram Properties", "Determines whether the grid is drawn or not.", Me.DrawGrid))

            m_Properties.Properties.Add(New Crownwood.Magic.Controls.PropertySpec("Grid Color", GetType(System.Drawing.Color), "GridColor", _
                                        "Diagram Properties", "Sets the color of the grid.", Me.GridColor))

            m_Properties.Properties.Add(New Crownwood.Magic.Controls.PropertySpec("Grid Size", GetType(System.Drawing.Size), "GridSize", _
                                        "Diagram Properties", "Sets the size of the space (width or height) between grid lines.", Me.GridSize))

            m_Properties.Properties.Add(New Crownwood.Magic.Controls.PropertySpec("Snap To Grid", GetType(Boolean), "GridSnap", _
                                        "Diagram Properties", "Determines whether the diagram items snap to the grid locations.", Me.GridSnap))

            m_Properties.Properties.Add(New Crownwood.Magic.Controls.PropertySpec("Grid Style", GetType(enumGridStyle), "GridStyle", _
                                        "Diagram Properties", "Sets the style of line used to draw the grid.", Me.GridStyle))

            m_Properties.Properties.Add(New Crownwood.Magic.Controls.PropertySpec("Back Color", GetType(System.Drawing.Color), "AddFlowBackColor", _
                                        "Diagram Properties", "Sets the background color for the control.", Me.AddFlowBackColor))

            m_Properties.Properties.Add(New Crownwood.Magic.Controls.PropertySpec("Jump Size", GetType(enumJumpSize), "JumpSize", _
                                        "Diagram Properties", "Sets the size of the jumps at the intersection of links.", Me.JumpSize))

            m_Properties.Properties.Add(New Crownwood.Magic.Controls.PropertySpec("Tab Index", GetType(Integer), "SetDiagramIndex", _
...
#Region " Menu Methods "
        ...
        Protected Sub CreateDiagramPopupMenu(ByVal ptScreen As Point)
            ...
            Dim mcPasteInPlace As New MenuCommand("Paste In Place", "PasteInPlace", m_beEditor.SmallImages.ImageList, _
                                            m_beEditor.SmallImages.GetImageIndex("AnimatTools.Paste.gif"), _
            ...
            Dim mcRelabel As New MenuCommand("Relabel", "Relabel", Me.Editor.SmallImages.ImageList, _
                                              Me.Editor.SmallImages.GetImageIndex("AnimatTools.Relabel.gif"), _
                                              New EventHandler(AddressOf Me.OnRelabel))
            Dim mcRelabelSelected As New MenuCommand("Relabel Selected", "RelabelSelected", Me.Editor.SmallImages.ImageList, _
                                              Me.Editor.SmallImages.GetImageIndex("AnimatTools.RelabelSelected.gif"), _
            ...
            Dim mcSendToBack As New MenuCommand("Send To Back", "SendToBack", m_beEditor.SmallImages.ImageList, _
                                        m_beEditor.SmallImages.GetImageIndex("AnimatTools.SendToBack.gif"), New EventHandler(AddressOf Me.OnSendToBack))
            Dim mcBringToFront As New MenuCommand("Bring To Front", "BringToFront", m_beEditor.SmallImages.ImageList, _
                                        m_beEditor.SmallImages.GetImageIndex("AnimatTools.BringToFront.gif"), New EventHandler(AddressOf Me.OnBringToFront))
            ...
            If aryList.Count > 1 Then
                Dim mcAlign As New MenuCommand("Align", "Align", m_beEditor.SmallImages.ImageList, m_beEditor.SmallImages.GetImageIndex("AnimatTools.Align.gif"))
                Dim mcAlignTop As New MenuCommand("Top", "AlignTop", m_beEditor.SmallImages.ImageList, _
                                                m_beEditor.SmallImages.GetImageIndex("AnimatTools.AlignTop.gif"), New EventHandler(AddressOf Me.OnAlignTop))
                Dim mcAlignVerticalCenter As New MenuCommand("Veritcal Center", "AlignVeritcalCenter", _
                                                            m_beEditor.SmallImages.ImageList, _
                                                            m_beEditor.SmallImages.GetImageIndex("AnimatTools.AlignVerticalCenter.gif"), _
                                                            New EventHandler(AddressOf Me.OnAlignVerticalCenter))
                Dim mcAlignBottom As New MenuCommand("Bottom", "AlignBottom", m_beEditor.SmallImages.ImageList, _
                                                    m_beEditor.SmallImages.GetImageIndex("AnimatTools.AlignBottom.gif"), _
                                                    New EventHandler(AddressOf Me.OnAlignBottom))
                Dim mcAlignLeft As New MenuCommand("Left", "AlignLeft", m_beEditor.SmallImages.ImageList, _
                                                m_beEditor.SmallImages.GetImageIndex("AnimatTools.AlignLeft.gif"), _
                ...
                Dim mcAlignHorizontalCenter As New MenuCommand("Horizontal Center", "AlignHorizontalCenter", _
                                                            m_beEditor.SmallImages.ImageList, _
                                                            m_beEditor.SmallImages.GetImageIndex("AnimatTools.AlignHorizontalCenter.gif"), _
                                                            New EventHandler(AddressOf Me.OnAlignHorizontalCenter))
                Dim mcAlignRight As New MenuCommand("Right", "AlignRight", m_beEditor.SmallImages.ImageList, _
                                                    m_beEditor.SmallImages.GetImageIndex("AnimatTools.AlignRight.gif"), _
                ...
                Dim mcDistribute As New MenuCommand("Distribute", "Distribute", m_beEditor.SmallImages.ImageList, m_beEditor.SmallImages.GetImageIndex("AnimatTools.Distribute.gif"))
                Dim mcDistributeVertical As New MenuCommand("Veritcal", "DistributeVertical", _
                                                            m_beEditor.SmallImages.ImageList, _
                                                            m_beEditor.SmallImages.GetImageIndex("AnimatTools.DistributeVertical.gif"), _
                ...
                Dim mcDistributeHorizontal As New MenuCommand("Horizontal", "DistributeHorizontal", _
                                                            m_beEditor.SmallImages.ImageList, _
                                                            m_beEditor.SmallImages.GetImageIndex("AnimatTools.DistributeHorizontal.gif"), _
                ...
                Dim mcSize As New MenuCommand("Size", "Size", m_beEditor.SmallImages.ImageList, m_beEditor.SmallImages.GetImageIndex("AnimatTools.Size.gif"))
                Dim mcSizeBoth As New MenuCommand("Both", "SizeBoth", m_beEditor.SmallImages.ImageList, _
                                                m_beEditor.SmallImages.GetImageIndex("AnimatTools.SizeBoth.gif"), _
                                                New EventHandler(AddressOf Me.OnSizeBoth))
                Dim mcSizeWidth As New MenuCommand("Width", "SizeWidth", m_beEditor.SmallImages.ImageList, _
                                                m_beEditor.SmallImages.GetImageIndex("AnimatTools.SizeWidth.gif"), _
                                                New EventHandler(AddressOf Me.OnSizeWidth))
                Dim mcSizeHeight As New MenuCommand("Height", "SizeHeight", m_beEditor.SmallImages.ImageList, _
                                                    m_beEditor.SmallImages.GetImageIndex("AnimatTools.SizeHeight.gif"), _
            ...
            Dim mcZoomIn As New MenuCommand("Zoom In", "ZoomIn", m_beEditor.SmallImages.ImageList, _
                                              m_beEditor.SmallImages.GetImageIndex("AnimatTools.ZoomIn.gif"), _
            ...
            Dim mcZoomOut As New MenuCommand("Zoom Out", "ZoomOut", m_beEditor.SmallImages.ImageList, _
                                              m_beEditor.SmallImages.GetImageIndex("AnimatTools.ZoomOut.gif"), _
            ...
            If aryList.Count = 1 Then
                ...
                Dim doNode As AnimatTools.DataObjects.Behavior.Node = FindNode(DirectCast(afNode.Tag, String))
                ...
                Dim mcShowConnections As New MenuCommand("ShowConnections", "ShowConnections", m_beEditor.SmallImages.ImageList, _
                                                  m_beEditor.SmallImages.GetImageIndex("AnimatTools.Connections.gif"), _
...
#Region " Load/Save "
        ...
        Protected Overridable Sub LoadNodes(ByRef oXml As AnimatTools.Interfaces.StdXml)
            ...
            Try
                ...
                For iIndex As Integer = 0 To iCount
                    ...
                    bnNode = DirectCast(Util.LoadClass(strAssemblyFile, strClassName, Me.FormHelper), AnimatTools.DataObjects.Behavior.Node)
        ...
        Protected Overridable Sub LoadLinks(ByRef oXml As AnimatTools.Interfaces.StdXml)
            Dim strAssemblyFile As String
            Dim strClassName As String
            ...
            Try
                ...
                For iIndex As Integer = 0 To iCount
                    ...
                    blLink = DirectCast(Util.LoadClass(strAssemblyFile, strClassName, Me.FormHelper), AnimatTools.DataObjects.Behavior.Link)
                    blLink.ParentDiagram = Me
                    blLink.ParentEditor = m_beEditor
        ...
        Protected Overridable Sub LoadDiagrams(ByRef oXml As AnimatTools.Interfaces.StdXml)
            Dim strAssemblyFile As String
            Dim strClassName As String
        ...
        Protected Overridable Sub LoadAddFlow(ByRef oXml As AnimatTools.Interfaces.StdXml)
        ...
        Public Overrides Sub InitializeAfterLoad()
            ...
            Try
                InitializeDataAfterLoad(m_aryNodes)
                InitializeDataAfterLoad(m_aryLinks)
                ...
                For Each deEntry As DictionaryEntry In Me.Nodes
                    doNode = DirectCast(deEntry.Value, AnimatTools.DataObjects.Behavior.Node)
                    If doNode.DiagramImageName.Length > 0 Then
                        ...
                        Else
                            Dim doImg As AnimatTools.DataObjects.Behavior.DiagramImage = Me.Editor.DiagramImages.FindDiagramImageByID(doNode.DiagramImageName)
                ...
                Dim doImage As AnimatTools.DataObjects.Behavior.DiagramImage
                For Each deEntry As DictionaryEntry In Me.Editor.DiagramImages
                    doImage = DirectCast(deEntry.Value, AnimatTools.DataObjects.Behavior.DiagramImage)
                    Dim iIndex As Integer = FindDiagramImageIndex(doImage.Image, False)
                    If iIndex < 0 Then
                        Me.AddImage(doImage)
                    End If
                Next
        ...
        Public Overrides Sub VerifyData()
            Try
                ...
                Dim bdItem As AnimatTools.DataObjects.Behavior.Data
                For Each deEntry As DictionaryEntry In m_aryNodes
                    bdItem = DirectCast(deEntry.Value, AnimatTools.DataObjects.Behavior.Data)
        ...
        Protected Overrides Sub VerifyNodesExist()
            ...
            Try
                ...
                Dim bdData As AnimatTools.DataObjects.Behavior.Data
                Dim afItem As Lassalle.Flow.Item
        ...
        Protected Overridable Sub SaveNodes(ByRef oXml As AnimatTools.Interfaces.StdXml)
        ...
        Protected Overridable Sub SaveLinks(ByRef oXml As AnimatTools.Interfaces.StdXml)
        ...
        Protected Overridable Overloads Sub SaveDiagrams(ByRef oXml As AnimatTools.Interfaces.StdXml)
        ...
        Protected Overridable Sub SaveAddFlow(ByRef oXml As AnimatTools.Interfaces.StdXml)
        ...
        Public Overrides Function SaveSelected(ByRef oXml As AnimatTools.Interfaces.StdXml, ByVal bCopy As Boolean) As Boolean
            ...
            Dim aryNodes As New AnimatTools.Collections.Nodes(Nothing)
            Dim aryLinks As New AnimatTools.Collections.Links(Nothing)
            Dim aryItems As New AnimatTools.Collections.BehaviorItems(Nothing)
            Dim bdData As AnimatTools.DataObjects.Behavior.Data
            ...
            For Each afItem As Lassalle.Flow.Item In m_ctrlAddFlow.SelectedItems
                ...
                If bdData.CanCopy() Then
                    If TypeOf bdData Is AnimatTools.DataObjects.Behavior.Node Then
                        aryNodes.Add(DirectCast(bdData, AnimatTools.DataObjects.Behavior.Node))
                    ElseIf TypeOf bdData Is AnimatTools.DataObjects.Behavior.Link Then
                        aryLinks.Add(DirectCast(bdData, AnimatTools.DataObjects.Behavior.Link))
                    Else
            ...
            Dim bsSystem As AnimatTools.DataObjects.Behavior.Nodes.Subsystem
            For Each bnNode As AnimatTools.DataObjects.Behavior.Node In aryNodes
                If TypeOf bnNode Is AnimatTools.DataObjects.Behavior.Nodes.Subsystem Then
                    bsSystem = DirectCast(bnNode, AnimatTools.DataObjects.Behavior.Nodes.Subsystem)
            ...
            oXml.AddChildElement("Links")
            oXml.IntoElem() 'Into Links Element
            For Each blLink As AnimatTools.DataObjects.Behavior.Link In aryLinks
                blLink.SaveData(oXml)
            Next
            oXml.OutOfElem() 'Outof Links Element
            ...
            For Each bdItem As AnimatTools.DataObjects.Behavior.Data In aryItems
                bdItem.AfterCopy()
            Next
        ...
        Public Overrides Sub DumpNodeLinkInfo()
            ...
            For Each doItem As DictionaryEntry In Me.Nodes
                bnNode = DirectCast(doItem.Value, AnimatTools.DataObjects.Behavior.Node)
        ...
        Public Overrides Sub LoadSelected(ByRef oXml As AnimatTools.Interfaces.StdXml, ByVal bInPlace As Boolean)
            ...
            Dim strID As String
            Dim aryItems As New AnimatTools.Collections.BehaviorItems(Nothing)
            Dim aryDiagrams As New AnimatTools.Collections.Diagrams(Nothing)
            ...
            For Each bdData As AnimatTools.DataObjects.Behavior.Data In aryItems
                ...
                If Not afItem Is Nothing Then
                    ...
                    End If
                Else
                    If TypeOf bdData Is AnimatTools.DataObjects.Behavior.Node AndAlso m_aryNodes.Contains(bdData.ID) Then
                        m_aryNodes.Remove(bdData.ID)
                    ElseIf TypeOf bdData Is AnimatTools.DataObjects.Behavior.Link AndAlso m_aryLinks.Contains(bdData.ID) Then
                        m_aryLinks.Remove(bdData.ID)
                    End If
            ...
            For Each bdData As AnimatTools.DataObjects.Behavior.Data In aryRemoveItems
        ...
        Protected Sub InitializeImageDataAfterLoad(ByRef aryItems As AnimatTools.Collections.BehaviorItems)

            Dim doNode As AnimatTools.DataObjects.Behavior.Node
            For Each bdData As AnimatTools.DataObjects.Behavior.Data In aryItems
                If Util.IsTypeOf(bdData.GetType, GetType(AnimatTools.DataObjects.Behavior.Node)) Then
                    doNode = DirectCast(bdData, AnimatTools.DataObjects.Behavior.Node)
                    If doNode.DiagramImageName.Length > 0 Then
                        Dim afNode As Lassalle.Flow.Node = Me.FindAddFlowNode(doNode.ID)
                        Dim iIndex As Integer = FindDiagramImageIndex(Me.Editor.DiagramImages.FindImageByID(doNode.DiagramImageName), False)
                        If iIndex > -1 Then
...
#Region " Print "
        ...
        Public Overrides Sub GenerateMetafiles(ByVal aryMetaDocs As AnimatTools.Collections.MetaDocuments)

            aryMetaDocs.Add(New AnimatTools.DataObjects.Behavior.PrintHelper.MetaDocument(m_ctrlAddFlow.ExportMetafile(False, True, True), _
            ...
            Try
                ...
                If aryList.Count = 1 Then
                    ...
                    If doNode.AllowStimulus AndAlso doNode.CompatibleStimuli.Count > 0 Then
                        ...
                        If TypeOf (doNode) Is AnimatTools.DataObjects.Behavior.Nodes.OffPage Then
                            Dim opNode As AnimatTools.DataObjects.Behavior.Nodes.OffPage = DirectCast(doNode, AnimatTools.DataObjects.Behavior.Nodes.OffPage)
        ...
        Public Overrides Sub OnShowConnections(ByVal sender As Object, ByVal e As System.EventArgs)
            ...
            Try
                ...
                If aryList.Count = 1 Then
                    ...
                    If TypeOf doNode Is AnimatTools.DataObjects.Behavior.Nodes.OffPage Then
                        Dim doOffpage As AnimatTools.DataObjects.Behavior.Nodes.OffPage = DirectCast(doNode, AnimatTools.DataObjects.Behavior.Nodes.OffPage)
                    ...
                    Dim frmConn As New AnimatTools.Forms.Behavior.Connections
        ...
        Public Overrides Sub OnCompareItems(ByVal sender As Object, ByVal e As System.EventArgs)
            ...
            Try
                ...
                For Each oItem As Object In Me.Editor.SelectedObjects()
                    If TypeOf oItem Is AnimatTools.Framework.DataObject Then
                        Dim doItem As AnimatTools.Framework.DataObject = DirectCast(oItem, AnimatTools.Framework.DataObject)
...
#Region " AddFlow Events "
        ...
        Private Sub m_ctrlAddFlow_DragDrop(ByVal sender As Object, ByVal e As System.Windows.Forms.DragEventArgs) Handles m_ctrlAddFlow.DragDrop
            ...
            Try
                ...
                If (e.Data.GetDataPresent(GetType(Crownwood.Magic.Controls.PanelIcon))) Then
                    ...
                    Dim bdDropData As AnimatTools.DataObjects.Behavior.Data = DirectCast(pnlIcon.Data, AnimatTools.DataObjects.Behavior.Data)

                    If Not bdDropData Is Nothing And TypeOf (bdDropData) Is AnimatTools.DataObjects.Behavior.Node Then
                        Dim bdData As AnimatTools.DataObjects.Behavior.Node = DirectCast(bdDropData.Clone(Me.Editor.Organism, False, Nothing), AnimatTools.DataObjects.Behavior.Node)
        ...
        Private Sub m_ctrlAddFlow_AfterAddLink(ByVal sender As Object, ByVal e As Lassalle.Flow.AfterAddLinkEventArgs) Handles m_ctrlAddFlow.AfterAddLink
            ...
            Try
                ...
                Dim bnOrigin As AnimatTools.DataObjects.Behavior.Node = FindNode(DirectCast(e.Link.Org.Tag, String))
                Dim bnDestination As AnimatTools.DataObjects.Behavior.Node = FindNode(DirectCast(e.Link.Dst.Tag, String))
                Dim blLink As AnimatTools.DataObjects.Behavior.Link
                ...
                If m_beEditor.SelectLinkType(bnOrigin, bnDestination, blLink, bRequiresAdapter) Then
                    ...
                    Else
                        ...
                        Dim bnAdapter As AnimatTools.DataObjects.Behavior.Node = bnDestination.CreateNewAdapter(bnOrigin, Me.FormHelper)
                        ...
                        blLink = DirectCast(blLink.Clone(Me.Editor.Organism, False, Nothing), AnimatTools.DataObjects.Behavior.Link)

                        blLink.BeginBatchUpdate()
                        blLink.ArrowDestination = New AnimatTools.DataObjects.Behavior.Link.Arrow(blLink, AnimatTools.DataObjects.Behavior.Link.enumArrowStyle.Arrow, _
                                                                                      AnimatTools.DataObjects.Behavior.Link.enumArrowSize.Small, _
                                                                                      AnimatTools.DataObjects.Behavior.Link.enumArrowAngle.deg15, False)
                        blLink.EndBatchUpdate(False)
        ...
        Private Sub m_ctrlAddFlow_AfterEdit(ByVal sender As Object, ByVal e As Lassalle.Flow.AfterEditEventArgs) Handles m_ctrlAddFlow.AfterEdit
            Try
                ...
                If Not e.Node Is Nothing Then
                    Dim bnNode As AnimatTools.DataObjects.Behavior.Node = FindNode(DirectCast(e.Node.Tag, String))
        ...
        Private Sub m_ctrlAddFlow_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles m_ctrlAddFlow.DoubleClick
            ...
            Try
                ...
                If Not afItem Is Nothing Then
                    Dim bdItem As AnimatTools.DataObjects.Behavior.Data = FindItem(DirectCast(afItem.Tag, String), False)
                    If Not bdItem Is Nothing Then
