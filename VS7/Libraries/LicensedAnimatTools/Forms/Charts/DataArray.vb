...
#Region " Methods "
        ...
        Protected Overridable Sub PrepareForCharting()
            ...
            If Not Util.Application.SimulationView Is Nothing AndAlso Not Util.Application.SimulationView.Simulator Is Nothing _
               AndAlso Util.Application.SimulationView.Simulator.Loaded AndAlso Util.Application.SimulationView.Simulator.Paused AndAlso _
               Not m_aryDataColumns Is Nothing AndAlso m_aryDataColumns.Rank = 2 Then
        ...
        Protected Overridable Sub UpdateChartData()
            Try
                ...
                Util.Application.SimulationView.Simulator.RetrieveChartData(m_strID, aryXData, m_aryYData)
                UpdateChart()
        ...
        Protected Overrides Sub BuildProperties()
            ...
            Dim pbNumberBag As Crownwood.Magic.Controls.PropertyBag = m_snUpdateDataInterval.Properties
            ...
            m_Properties.Properties.Add(New Crownwood.Magic.Controls.PropertySpec("Data", Me.GetType(), "DataChart", _
            ...
            m_Properties.Properties.Add(New Crownwood.Magic.Controls.PropertySpec("Y Axis Color", GetType(System.Drawing.Color), "YAxisColor", _
                                        "Graphical Properties", "Determines the color of the y axis.", Me.YAxisColor))

            m_Properties.Properties.Add(New Crownwood.Magic.Controls.PropertySpec("Z Axis Color", GetType(System.Drawing.Color), "ZAxisColor", _
            ...
            m_Properties.Properties.Add(New Crownwood.Magic.Controls.PropertySpec("X Axis Label", GetType(String), "XAxisLabel", _
                                        "Graphical Properties", "Sets the label for the x axis of this chart.", Me.XAxisLabel))

            m_Properties.Properties.Add(New Crownwood.Magic.Controls.PropertySpec("Y Axis Label", GetType(String), "YAxisLabel", _
                                        "Graphical Properties", "Sets the label for the y axis of this chart.", Me.YAxisLabel))

            m_Properties.Properties.Add(New Crownwood.Magic.Controls.PropertySpec("Z Axis Label", GetType(String), "ZAxisLabel", _
                                        "Graphical Properties", "Sets the label for the z axis of this chart.", Me.ZAxisLabel))

            m_Properties.Properties.Add(New Crownwood.Magic.Controls.PropertySpec("Y AutoScale", GetType(enumScaleControl), "YAutoScale", _
                                        "Graphical Properties", "Determines whether the y axis is automatically scaled to fit the data."))

            m_Properties.Properties.Add(New Crownwood.Magic.Controls.PropertySpec("Y Min Value", GetType(Double), "YMin", _
                                        "Graphical Properties", "Sets the minimum size of the Y axis.", Me.YMin))

            m_Properties.Properties.Add(New Crownwood.Magic.Controls.PropertySpec("Y Max Value", GetType(Double), "YMax", _
                                        "Graphical Properties", "Sets the maximum size of the y axis.", Me.YMax))

            m_Properties.Properties.Add(New Crownwood.Magic.Controls.PropertySpec("Color Bars By Height", GetType(Boolean), "ColorBarsByHeight", _
            ...
            'm_Properties.Properties.Add(New Crownwood.Magic.Controls.PropertySpec("Base Color", GetType(System.Drawing.Color), "BaseBarColor", _
            '                            "Bar Coloring", "Sets the color of a bar if it is at the base level.", Me.BaseBarColor))

            'm_Properties.Properties.Add(New Crownwood.Magic.Controls.PropertySpec("Min Color", GetType(System.Drawing.Color), "MinBarColor", _
            '                            "Bar Coloring", "Sets the color of a bar if it is at the minimum level.", Me.MinBarColor))

            'm_Properties.Properties.Add(New Crownwood.Magic.Controls.PropertySpec("Max Color", GetType(System.Drawing.Color), "MaxBarColor", _
            '                            "Bar Coloring", "Sets the color of a bar if it is at the minimum level.", Me.MaxBarColor))

            m_Properties.Properties.Add(New Crownwood.Magic.Controls.PropertySpec("Base Value", GetType(Single), "BaseBarValue", _
                                        "Bar Coloring", "Sets the base value for bar coloring.", Me.BaseBarValue))

            m_Properties.Properties.Add(New Crownwood.Magic.Controls.PropertySpec("Min Value", GetType(Single), "MinBarValue", _
                                        "Bar Coloring", "Sets the minimum value for bar coloring.", Me.MinBarValue))

            m_Properties.Properties.Add(New Crownwood.Magic.Controls.PropertySpec("Max Value", GetType(Single), "MaxBarValue", _
        ...
        Public Overrides Sub SaveXml(ByRef oXml As Interfaces.StdXml)
            'It makes NO sense to use this chart in a standalone manner. It is 
            'only useful when you can view the gui output in the editor system
