            ...
            If Not Util.Application.SimulationView Is Nothing AndAlso Not Util.Application.SimulationView.Simulator Is Nothing _
               AndAlso Util.Application.SimulationView.Simulator.Loaded AndAlso Util.Application.SimulationView.Simulator.Paused Then
                ...
                If Util.Application.SimulationView.Simulator.FindDataChart(Me.ParentChart.ID, False) Then
                    If Not Util.Application.SimulationView.Simulator.FindDataColumn(Me.ParentChart.ID, Me.ID, False) Then
                        Util.DisableDirtyFlags = True
                        Dim strXml As String = Me.SaveDataColumnToXml()
                        Util.Application.SimulationView.Simulator.AddDataColumn(Me.ParentChart.ID, Me.ID, Me.ColumnModuleName, Me.ColumnClassType, strXml)
...
#Region " DataObject Methods "
        ...
        Protected Overrides Sub BuildProperties()
            ...
            m_Properties.Properties.Add(New Crownwood.Magic.Controls.PropertySpec("Bar Color", m_clLineColor.GetType(), "LineColor", _
