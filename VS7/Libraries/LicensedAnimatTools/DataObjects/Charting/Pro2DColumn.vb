...
#Region " Attributes "
        ...
        Protected m_frmLineChart As LicensedAnimatTools.Forms.Charts.LineChart
...
#Region " Properties "
        ...
        Public Overridable ReadOnly Property LineChart() As LicensedAnimatTools.Forms.Charts.LineChart
            Get
...
#Region " Methods "
        ...
        Public Sub New(ByVal doParent As AnimatTools.Framework.DataObject)
            ...
            m_frmLineChart = DirectCast(doAxis.ParentChart, LicensedAnimatTools.Forms.Charts.LineChart)
            ...
            If Not Util.Application.SimulationView Is Nothing AndAlso Not Util.Application.SimulationView.Simulator Is Nothing _
               AndAlso Util.Application.SimulationView.Simulator.Loaded AndAlso Util.Application.SimulationView.Simulator.Paused Then
                If Util.Application.SimulationView.Simulator.FindDataColumn(Me.ParentAxis.ParentChart.ID, Me.ID, False) Then
                    Util.Application.SimulationView.Simulator.SetDataColumnIndex(Me.ParentAxis.ParentChart.ID, Me.ID, Me.DataSubSet)
                End If
            End If
...
#Region " DataObject Methods "
        ...
        Protected Overrides Sub BuildProperties()
            ...
            m_Properties.Properties.Add(New Crownwood.Magic.Controls.PropertySpec("Line Type", m_eLineType.GetType(), "LineType", _
                                        "Column Properties", "Sets the type of line to draw on the chart for this data column.", m_eLineType))

            m_Properties.Properties.Add(New Crownwood.Magic.Controls.PropertySpec("Point Type", m_ePointType.GetType(), "PointType", _
                                        "Column Properties", "Sets the type of point to draw on the line for this data column.", m_ePointType))

            m_Properties.Properties.Add(New Crownwood.Magic.Controls.PropertySpec("Plot Method Type", m_ePlotMethodType.GetType(), "PlotMethodType", _
                                        "Column Properties", "Sets the type of plotting method to draw on the line for this data column.", m_ePlotMethodType))

            m_Properties.Properties.Add(New Crownwood.Magic.Controls.PropertySpec("Line Color", m_clLineColor.GetType(), "LineColor", _
