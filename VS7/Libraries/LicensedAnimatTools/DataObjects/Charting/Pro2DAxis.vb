...
Namespace DataObjects.Charting
    ...
    Public Class Pro2DAxis
        Inherits AnimatTools.DataObjects.Charting.Axis
...
#Region " Properties "
        ...
        Public Overrides Property ParentChart() As AnimatTools.Forms.Tools.DataChart
            Get
                Return m_frmParentChart
            End Get
            Set(ByVal Value As AnimatTools.Forms.Tools.DataChart)
...
#Region " Methods "
        ...
        Public Sub New(ByVal frmChart As AnimatTools.Forms.Tools.DataChart)
            MyBase.New(frmChart)
        ...
        Protected Overloads Overrides Sub DroppedItem(ByVal doItem As AnimatTools.DataObjects.DragObject)
            Dim doColumn As AnimatTools.DataObjects.Charting.DataColumn = CreateDataColumn(doItem)
            ...
            m_frmParentChart.Viewer.HierarchyBar.TreeView.SelectedNode = doColumn.TreeNode

            AddColumnToSimulation(doColumn, False)
        ...
        Protected Overloads Overrides Sub DroppedItem(ByVal doColumn As AnimatTools.DataObjects.Charting.DataColumn)
            doColumn.AutoAddToAxis = True
            doColumn.Name = doColumn.Name
            Me.DataColumns.Add(doColumn.ID, doColumn)
        ...
        Public Overrides Sub UpdateChartConfiguration(ByRef iSubSet As Integer)
            ...
            For Each deColumn As DictionaryEntry In Me.DataColumns
                doColumn = DirectCast(deColumn.Value, AnimatTools.DataObjects.Charting.DataColumn)
...
#Region " DataObject Methods "
        ...
        Protected Overrides Sub BuildProperties()
            ...
            m_Properties.Properties.Add(New Crownwood.Magic.Controls.PropertySpec("Axis Color", GetType(System.Drawing.Color), "AxisColor", _
                                        "Axis Properties", "Determines the color of this axis.", Me.AxisColor))

            m_Properties.Properties.Add(New Crownwood.Magic.Controls.PropertySpec("Axis Scale", GetType(Integer), "AxisScaleValue", _
            ...
            m_Properties.Properties.Add(New Crownwood.Magic.Controls.PropertySpec("AutoScale", GetType(enumScaleControl), "AutoScale", _
                                        "Axis Properties", "Determines whether this axis is automatically scaled to fit the data."))

            m_Properties.Properties.Add(New Crownwood.Magic.Controls.PropertySpec("Min Value", GetType(Double), "Min", _
                                        "Axis Properties", "Sets the minimum size limit for data for this axis.", Me.Min))

            m_Properties.Properties.Add(New Crownwood.Magic.Controls.PropertySpec("Max Value", GetType(Double), "Max", _
