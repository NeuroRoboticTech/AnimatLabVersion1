...
void Stomach::Load(Simulator *lpSim, Structure *lpStructure, CStdXml &oXml)
{
	...
	m_fltMaxEnergyLevel = AnimatLibrary::LoadScaledNumber(oXml, "MaxEnergyLevel", FALSE, m_fltMaxEnergyLevel);
	m_fltEnergyLevel = AnimatLibrary::LoadScaledNumber(oXml, "EnergyLevel", FALSE, m_fltEnergyLevel);
	m_fltBaseConsumptionRate = AnimatLibrary::LoadScaledNumber(oXml, "BaseConsumptionRate", FALSE, m_fltBaseConsumptionRate);
