...
float LinearHillMuscle::CalculateMuscleLength(Simulator *lpSim)
{
	float fltLength=0;
...
void LinearHillMuscle::CreateParts(Simulator *lpSim, Structure *lpStructure)
{
}
...
void LinearHillMuscle::AddExternalNodeInput(Simulator *lpSim, Structure *lpStructure, float fltInput)
{
...
void LinearHillMuscle::Load(Simulator *lpSim, Structure *lpStructure, CStdXml &oXml)
{
	...
	//Std_InValidRange((float) 0, (float) 1, m_fltTLwidth, TRUE, "TLwidth");
