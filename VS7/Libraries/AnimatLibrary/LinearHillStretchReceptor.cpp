...
void LinearHillStretchReceptor::Load(Simulator *lpSim, Structure *lpStructure, CStdXml &oXml)
{
	...
	m_fltIaDischargeConstant = AnimatLibrary::LoadScaledNumber(oXml, "IaDischarge", FALSE, m_fltIaDischargeConstant);
	m_fltIIDischargeConstant = AnimatLibrary::LoadScaledNumber(oXml, "IIDischarge", FALSE, m_fltIIDischargeConstant);
