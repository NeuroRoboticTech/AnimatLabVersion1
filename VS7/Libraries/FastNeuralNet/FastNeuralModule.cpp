// Brain.cpp: implementation of the FastNeuralModule class.
//
//////////////////////////////////////////////////////////////////////
...
FastNeuralModule::FastNeuralModule()
{
	m_lpClassFactory =  new FastNeuralNet::ClassFactory;
...
{Std_TraceMsg(0, "Caught Error in desctructor of FastNeuralModule\r\n", "", -1, FALSE, TRUE);}
}

BOOL FastNeuralModule::ActiveArray()
{return m_bActiveArray;}

void FastNeuralModule::ActiveArray(BOOL bVal)
{
	m_bActiveArray = bVal;
}

BOOL FastNeuralModule::InactiveArray()
{return !m_bActiveArray;}

void FastNeuralModule::InactiveArray(BOOL bVal)
{
	m_bActiveArray = !bVal;
}

Node *FastNeuralModule::FindNode(long lNodeID)
{
...
Neuron *FastNeuralModule::GetNeuron(short iXPos, short iYPos, short iZPos)
{
	unsigned int iIndex;
...
void FastNeuralModule::SetNeuron(unsigned char iXPos, 
                         unsigned char iYPos, 
                         unsigned char iZPos, 
                         Neuron *lpNeuron)
{
...
void FastNeuralModule::Kill(Simulator *lpSim, Organism *lpOrganism, BOOL bState)
{
...
void FastNeuralModule::Reset(Simulator *lpSim, Organism *lpOrganism)
{
	unsigned char iXPos, iYPos, iZPos;
	Neuron *lpNeuron=NULL;
...
void FastNeuralModule::Initialize(Simulator *lpSim, Structure *lpStructure)
{
	unsigned char iXPos, iYPos, iZPos;
	Neuron *lpNeuron=NULL;
...
void FastNeuralModule::StepSimulation(Simulator *lpSim, Structure *lpStructure)
{
	unsigned char iXPos, iYPos, iZPos;
	Neuron *lpNeuron=NULL;
...
void FastNeuralModule::GenerateAutoSeed()
{
	SYSTEMTIME st;
	GetLocalTime(&st);
...
long FastNeuralModule::CalculateSnapshotByteSize()
{
	unsigned char iXPos, iYPos, iZPos;
	Neuron *lpNeuron=NULL;
	long lByteSize = 0;
...
void FastNeuralModule::SaveKeyFrameSnapshot(byte *aryBytes, long &lIndex)
{
	unsigned char iXPos, iYPos, iZPos;
	Neuron *lpNeuron=NULL;
...
void FastNeuralModule::LoadKeyFrameSnapshot(byte *aryBytes, long &lIndex)
{
	unsigned char iXPos, iYPos, iZPos;
	Neuron *lpNeuron=NULL;
...
void FastNeuralModule::Load(Simulator *lpSim, Structure *lpStructure, CStdXml &oXml)
{
	CStdXml oNetXml;
...
void FastNeuralModule::LoadNetworkXml(Simulator *lpSim, Structure *lpStructure, CStdXml &oXml)
{
...
Neuron *FastNeuralModule::LoadNeuron(Simulator *lpSim, Structure *lpStructure, CStdXml &oXml)
{
	Neuron *lpNeuron=NULL;
	string strType;
	CStdIPoint oPos;
...
void FastNeuralModule::Save(Simulator *lpSim, Structure *lpStructure, CStdXml &oXml)
{
	Neuron *lpNeuron=NULL;
	short iX, iY, iZ;
