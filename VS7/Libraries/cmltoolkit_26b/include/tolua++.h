...
** TeCGraf/PUC-Rio
** Apr 2003
** $Id: tolua++.h,v 1.4 2004/11/19 21:28:29 marek Exp $
*/
...
#define TOLUA_VERSION "tolua++-1.0.3"
...
TOLUA_API void tolua_array1 (lua_State* L,char* name, lua_CFunction get, lua_CFunction set, int dim);
TOLUA_API void tolua_array2 (lua_State* L, char* name, lua_CFunction get, lua_CFunction set, lua_CFunction settable, int dim);
