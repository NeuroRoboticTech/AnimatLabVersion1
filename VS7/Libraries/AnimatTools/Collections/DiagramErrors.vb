...
Namespace Collections
    ...
    Public Class DiagramErrors
        ...
        Default Public Property Item(ByVal key As [String]) As AnimatTools.DataObjects.Behavior.DiagramError
            Get
                Return CType(Dictionary(key), AnimatTools.DataObjects.Behavior.DiagramError)
            End Get
            Set(ByVal Value As AnimatTools.DataObjects.Behavior.DiagramError)
        ...
        Public Sub Add(ByVal key As [String], ByVal value As AnimatTools.DataObjects.Behavior.DiagramError)
        ...
        Protected Overrides Sub OnInsert(ByVal key As [Object], ByVal value As [Object])
            ...
            If Not TypeOf (value) Is AnimatTools.DataObjects.Behavior.DiagramError Then
                Throw New ArgumentException("value must be of type AnimatTools.DataObjects.Behavior.DiagramError.", "value")
            End If

            Dim deError As AnimatTools.DataObjects.Behavior.DiagramError = DirectCast(value, AnimatTools.DataObjects.Behavior.DiagramError)
        ...
        Protected Overrides Sub OnSet(ByVal key As [Object], ByVal oldValue As [Object], ByVal newValue As [Object])
            ...
            If Not TypeOf (newValue) Is AnimatTools.DataObjects.Behavior.DiagramError Then
                Throw New ArgumentException("newValue must be of type AnimatTools.DataObjects.Behavior.DiagramError.", "newValue")
            End If
        End Sub 'OnSet
