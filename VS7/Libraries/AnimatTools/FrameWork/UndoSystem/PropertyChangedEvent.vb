...
#Region " Methods "
        ...
        Protected Overridable Sub EnsureFormVisible()
            ...
            If Not m_mdiParent Is Nothing AndAlso TypeOf m_AlteredObject Is AnimatTools.Framework.DataObject Then
                Dim doObject As AnimatTools.Framework.DataObject = DirectCast(m_AlteredObject, AnimatTools.Framework.DataObject)

                Dim mdiChild As AnimatTools.Forms.MdiChild = doObject.EnsureParentMdiShown()
                If Not mdiChild Is Nothing Then
                    m_mdiParent = mdiChild
                    m_mdiParent.MakeVisible()
                    m_mdiParent = Nothing
                End If
            End If
        ...
        Protected Overridable Sub RefreshParent(ByVal frmObject As AnimatTools.Forms.AnimatForm)
        ...
        Public Overrides Sub Undo()
            ...
            Dim frmObject As AnimatTools.Forms.AnimatForm
            ...
            Try
                ...
                ElseIf TypeOf m_AlteredObject Is AnimatTools.Forms.AnimatForm Then
                    frmObject = DirectCast(m_AlteredObject, AnimatTools.Forms.AnimatForm)
