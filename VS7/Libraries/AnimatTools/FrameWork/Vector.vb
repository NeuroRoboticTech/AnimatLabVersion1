...
Namespace Framework
    ...
    Public Class Vec3i
        ...
        Public Sub New(ByVal doParent As AnimatTools.Framework.DataObject, ByVal iX As Integer, ByVal iY As Integer, ByVal iZ As Integer)
            MyBase.New(doParent)
        ...
        Protected Overrides Sub BuildProperties()
            ...
            m_Properties.Properties.Add(New Crownwood.Magic.Controls.PropertySpec("X", m_iX.GetType(), "X", _
                                        "Vector Properties", "X value of the vector. ", Me.X))

            m_Properties.Properties.Add(New Crownwood.Magic.Controls.PropertySpec("Y", m_iY.GetType(), "Y", _
                                        "Vector Properties", "Y value of the vector. ", Me.Y))

            m_Properties.Properties.Add(New Crownwood.Magic.Controls.PropertySpec("Z", m_iZ.GetType(), "Z", _
    ...
    Public Class Vec3d
        ...
        Public Sub New(ByVal doParent As AnimatTools.Framework.DataObject, ByVal dblX As Double, ByVal dblY As Double, ByVal dblZ As Double)
            MyBase.New(doParent)
        ...
        Protected Overrides Sub BuildProperties()
            ...
            m_Properties.Properties.Add(New Crownwood.Magic.Controls.PropertySpec("X", m_dblX.GetType(), "X", _
                                        "Vector Properties", "X value of the vector. ", Me.X))

            m_Properties.Properties.Add(New Crownwood.Magic.Controls.PropertySpec("Y", m_dblY.GetType(), "Y", _
                                        "Vector Properties", "Y value of the vector. ", Me.Y))

            m_Properties.Properties.Add(New Crownwood.Magic.Controls.PropertySpec("Z", m_dblZ.GetType(), "Z", _
                                        "Vector Properties", "Z value of the vector. ", Me.Z))
