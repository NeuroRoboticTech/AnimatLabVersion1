...
#Region " Methods "
        ...
        Public Sub New(ByVal doParent As AnimatTools.Framework.DataObject, ByVal strPropertyName As String, ByVal fltValue As Double, ByVal eScale As enumNumericScale)
            MyBase.New(doParent)
        ...
        Public Sub New(ByVal doParent As AnimatTools.Framework.DataObject, ByVal strPropertyName As String, ByVal fltValue As Double, ByVal eScale As enumNumericScale, ByVal strUnits As String, ByVal strUnitsAbbrev As String)
            MyBase.New(doParent)
        ...
        Public Sub New(ByVal doParent As AnimatTools.Framework.DataObject, ByVal strPropertyName As String, ByVal strUnits As String, ByVal strUnitsAbbrev As String)
            MyBase.New(doParent)
        ...
        Protected Overrides Sub BuildProperties()
            ...
            m_Properties.Properties.Add(New Crownwood.Magic.Controls.PropertySpec("Value", m_fltValue.GetType(), "Value", _
                                        "Link Properties", "Sets the base value of this parameter.", m_fltValue))

            m_Properties.Properties.Add(New Crownwood.Magic.Controls.PropertySpec("Scale", m_eScale.GetType(), "Scale", _
                                        "Link Properties", "Sets the numeric scale for this parameter. (Kilo, Micro, etc)", m_eScale))

            m_Properties.Properties.Add(New Crownwood.Magic.Controls.PropertySpec("Units", m_strUnits.GetType(), "Units", _
                                        "Link Properties", "The units for this parameter", m_strUnits, True))

            m_Properties.Properties.Add(New Crownwood.Magic.Controls.PropertySpec("Units Abbrev", m_strUnitsAbbrev.GetType(), "UnitsAbbreviation", _
        ...
        Public Shared Function IsValidXml(ByVal oXml As AnimatTools.Interfaces.StdXml, ByVal strName As String) As Boolean
        ...
        Protected Overridable Function UpdateParent(ByVal snNewValue As ScaledNumber) As Boolean
            ...
            Dim doHelper As AnimatTools.DataObjects.FormHelper

            If Not TypeOf m_doParent Is AnimatTools.DataObjects.FormHelper Then
                propInfo = m_doParent.GetType().GetProperty(m_strPropertyName)
            Else
                doHelper = DirectCast(m_doParent, AnimatTools.DataObjects.FormHelper)
            ...
            If Not propInfo Is Nothing Then
                ...
                Else
                    Dim frmParent As AnimatTools.Forms.AnimatForm = doHelper.AnimatParent
                    propInfo.SetValue(frmParent, snNewValue, Nothing)
                    Me.ManualAddPropertyHistory(m_doParent, m_strPropertyName, doOrig, snNewValue, True)
                End If

                Dim frmRoot As System.Windows.Forms.Form = Me.RootForm
                If Not frmRoot Is Nothing AndAlso TypeOf frmRoot Is AnimatTools.Forms.MdiChild Then
                    Dim mdiRoot As AnimatTools.Forms.MdiChild = DirectCast(frmRoot, AnimatTools.Forms.MdiChild)
...
#Region " ScaledNumericPropBagConverter "
        ...
        Public Class ScaledNumericPropBagConverter
            ...
            Public Overloads Overrides Function CanConvertTo(ByVal context As System.ComponentModel.ITypeDescriptorContext, ByVal destinationType As System.Type) As Boolean
                ...
                If destinationType Is GetType(Crownwood.Magic.Controls.PropertyBag) Then
                    Return True
                End If
            ...
            Protected Function GetUnitsFromPropTable(ByVal context As System.ComponentModel.ITypeDescriptorContext) As String
                ...
                Dim pbOuter As Crownwood.Magic.Controls.PropertyTable = DirectCast(context.Instance, Crownwood.Magic.Controls.PropertyTable)

                For Each propSpec As Crownwood.Magic.Controls.PropertySpec In pbOuter.Properties
                    If (propSpec.Category.Replace(" ", "").ToUpper() = context.PropertyDescriptor.Category.Replace(" ", "").ToUpper()) AndAlso _
                       (propSpec.Name.Replace(" ", "").ToUpper() = context.PropertyDescriptor.Name.Replace(" ", "").ToUpper()) Then
                        If TypeOf propSpec.DefaultValue Is Crownwood.Magic.Controls.PropertyTable Then
                            Dim pbNumber As Crownwood.Magic.Controls.PropertyTable = DirectCast(propSpec.DefaultValue, Crownwood.Magic.Controls.PropertyTable)

                            Dim psUnits As Crownwood.Magic.Controls.PropertySpec = DirectCast(pbNumber.Properties(3), Crownwood.Magic.Controls.PropertySpec)
            ...
            Protected Function GetUnitsFromDataObject(ByVal context As System.ComponentModel.ITypeDescriptorContext) As String
                ...
                Dim doData As AnimatTools.Framework.DataObject = DirectCast(context.Instance, AnimatTools.Framework.DataObject)
            ...
            Protected Function GetScaleFromPropTable(ByVal context As System.ComponentModel.ITypeDescriptorContext, ByVal oObject As Object) As ScaledNumber.enumNumericScale
                ...
                Dim pbOuter As Crownwood.Magic.Controls.PropertyTable = DirectCast(oObject, Crownwood.Magic.Controls.PropertyTable)
            ...
            Protected Function GetScaleFromDataObject(ByVal context As System.ComponentModel.ITypeDescriptorContext, ByVal oObject As Object) As ScaledNumber.enumNumericScale
                ...
                Dim doData As AnimatTools.Framework.DataObject = DirectCast(oObject, AnimatTools.Framework.DataObject)
                Dim propInfo As System.Reflection.PropertyInfo = doData.GetType().GetProperty(context.PropertyDescriptor.Name)
                Dim oVal As Object
                        ...
                        If UBound(aryParts) >= 0 Then
                            If IsNumeric(aryParts(0)) Then
                                If UBound(aryParts) >= 1 Then
                                    ...
                                    If TypeOf context.Instance Is Crownwood.Magic.Controls.PropertyTable Then
                                ...
                                Else
                                    ...
                                    ElseIf TypeOf context.Instance Is System.Array Then
                                        ...
                                        If aryData.Length > 0 Then
                                            ...
                                            If TypeOf oVal Is Crownwood.Magic.Controls.PropertyTable Then
            ...
            Public Overloads Overrides Function ConvertTo(ByVal context As System.ComponentModel.ITypeDescriptorContext, ByVal culture As System.Globalization.CultureInfo, ByVal value As Object, ByVal destinationType As System.Type) As Object
                If destinationType Is GetType(String) AndAlso TypeOf (value) Is Crownwood.Magic.Controls.PropertyTable Then
                    Dim pbValue As Crownwood.Magic.Controls.PropertyTable = DirectCast(value, Crownwood.Magic.Controls.PropertyTable)

                    Dim psValue As Crownwood.Magic.Controls.PropertySpec = DirectCast(pbValue.Properties(0), Crownwood.Magic.Controls.PropertySpec)
                    Dim psScale As Crownwood.Magic.Controls.PropertySpec = DirectCast(pbValue.Properties(1), Crownwood.Magic.Controls.PropertySpec)
                    Dim psUnits As Crownwood.Magic.Controls.PropertySpec = DirectCast(pbValue.Properties(2), Crownwood.Magic.Controls.PropertySpec)
                    Dim psUnitsAbbrev As Crownwood.Magic.Controls.PropertySpec = DirectCast(pbValue.Properties(3), Crownwood.Magic.Controls.PropertySpec)
                    ...
                    Return strValue
                ElseIf destinationType Is GetType(String) AndAlso TypeOf (value) Is AnimatTools.Framework.ScaledNumber Then
