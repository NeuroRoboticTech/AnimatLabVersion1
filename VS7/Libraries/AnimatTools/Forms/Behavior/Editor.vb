...
#Region " Attributes "
        ...
        Protected m_PropertiesBar As Forms.Properties
...
#Region " Properties "
        ...
        Public Overridable ReadOnly Property PropertiesBar() As Forms.Properties
            Get
...
#Region " Methods "
        ...
        Public Overrides Sub Initialize(ByVal frmApplication As AnimatApplication, _
            ...
            Try
                ...
                Dim afDiagram As AnimatForm = m_frmApplication.CreateForm("LicensedAnimatTools.dll", _
                                                                        "LicensedAnimatTools.Forms.Behavior.AddFlowDiagram", _
                                                                        "Page 1", Me)
                ...
                CreateImageManager()
                MyBase.Initialize(frmApplication, afDiagram)
                ...
                m_OutlookContent = m_dockManager.Contents.Add(m_OutlookBar, "Toolbox", m_mgrSmallImages.ImageList, m_mgrSmallImages.GetImageIndex("AnimatTools.Wrench_Small.gif"))
                ...
                m_PropertiesBar.Initialize(m_frmApplication, Me)

                m_PropertiesBar.Location = New Point(0, 0)
                m_PropertiesContent = m_dockManager.Contents.Add(m_PropertiesBar, "Properties", m_mgrSmallImages.ImageList, m_mgrSmallImages.GetImageIndex("AnimatTools.Properties.gif"))
                ...
                m_HierarchyBar.Initialize(m_frmApplication, Me)

                m_HierarchyBar.Location = New Point(0, 0)
                m_HierarchyContent = m_dockManager.Contents.Add(m_HierarchyBar, "Hierarchy", m_mgrSmallImages.ImageList, m_mgrSmallImages.GetImageIndex("AnimatTools.ProjectWorkspace.gif"))
                ...
                m_ModulesBar.Initialize(m_frmApplication, Me)

                m_ModulesBar.Location = New Point(0, 0)
                m_ModulesContent = m_dockManager.Contents.Add(m_ModulesBar, "Modules", m_mgrSmallImages.ImageList, m_mgrSmallImages.GetImageIndex("AnimatTools.Neuron.gif"))
                ...
                m_ErrorsBar.Initialize(m_frmApplication, Me)

                m_ErrorsBar.Location = New Point(0, 0)
                m_ErrorsContent = m_dockManager.Contents.Add(m_ErrorsBar, "Neural Network Errors", m_mgrSmallImages.ImageList, m_mgrSmallImages.GetImageIndex("AnimatTools.Error_Small.gif"))
                ...
                Me.Icon = m_frmApplication.SmallImages.LoadIcon(myAssembly, "AnimatTools.Neuron.ico")
...
#Region " Menu/Toolbar Methods "
        ...
        Protected Overrides Sub CreateMenu()
            ...
            Dim mcExport As New MenuCommand("Export", "Export", m_mgrSmallImages.ImageList, _
                                              m_mgrSmallImages.GetImageIndex("AnimatTools.Export.gif"), _
                                              New EventHandler(AddressOf Me.OnExport))

            Dim mcPageSetup As New MenuCommand("Page Setup", "PageSetup", m_mgrSmallImages.ImageList, _
                                              m_mgrSmallImages.GetImageIndex("AnimatTools.PageSetup.gif"), _
                                              New EventHandler(AddressOf Me.OnPageSetup))

            Dim mcPrintPreview As New MenuCommand("Print Preview", "PrintPreview", m_mgrSmallImages.ImageList, _
                                              m_mgrSmallImages.GetImageIndex("AnimatTools.PrintPreview.gif"), _
                                              New EventHandler(AddressOf Me.OnPrintPreview))

            Dim mcPrint As New MenuCommand("Print", "Print", m_mgrSmallImages.ImageList, _
                                              m_mgrSmallImages.GetImageIndex("AnimatTools.Print.gif"), _
            ...
            Dim mcZoomIn As New MenuCommand("ZoomIn", "ZoomIn", m_mgrSmallImages.ImageList, _
                                              m_mgrSmallImages.GetImageIndex("AnimatTools.ZoomIn.gif"), _
            ...
            Dim mcZoomOut As New MenuCommand("ZoomOut", "ZoomOut", m_mgrSmallImages.ImageList, _
                                              m_mgrSmallImages.GetImageIndex("AnimatTools.ZoomOut.gif"), _
            ...
            Dim mcAlign As New MenuCommand("Align", "Align", m_mgrSmallImages.ImageList, m_mgrSmallImages.GetImageIndex("AnimatTools.Align.gif"))
            Dim mcAlignTop As New MenuCommand("Top", "AlignTop", m_mgrSmallImages.ImageList, _
                                              m_mgrSmallImages.GetImageIndex("AnimatTools.AlignTop.gif"), New EventHandler(AddressOf Me.OnAlignTop))
            Dim mcAlignVerticalCenter As New MenuCommand("Veritcal Center", "AlignVeritcalCenter", _
                                                         m_mgrSmallImages.ImageList, _
                                                         m_mgrSmallImages.GetImageIndex("AnimatTools.AlignVerticalCenter.gif"), _
                                                         New EventHandler(AddressOf Me.OnAlignVerticalCenter))
            Dim mcAlignBottom As New MenuCommand("Bottom", "AlignBottom", m_mgrSmallImages.ImageList, _
                                                 m_mgrSmallImages.GetImageIndex("AnimatTools.AlignBottom.gif"), _
                                                 New EventHandler(AddressOf Me.OnAlignBottom))
            Dim mcAlignLeft As New MenuCommand("Left", "AlignLeft", m_mgrSmallImages.ImageList, _
                                             m_mgrSmallImages.GetImageIndex("AnimatTools.AlignLeft.gif"), _
            ...
            Dim mcAlignHorizontalCenter As New MenuCommand("Horizontal Center", "AlignHorizontalCenter", _
                                                         m_mgrSmallImages.ImageList, _
                                                         m_mgrSmallImages.GetImageIndex("AnimatTools.AlignHorizontalCenter.gif"), _
                                                         New EventHandler(AddressOf Me.OnAlignHorizontalCenter))
            Dim mcAlignRight As New MenuCommand("Right", "AlignRight", m_mgrSmallImages.ImageList, _
                                                m_mgrSmallImages.GetImageIndex("AnimatTools.AlignRight.gif"), _
            ...
            Dim mcDistribute As New MenuCommand("Distribute", "Distribute", m_mgrSmallImages.ImageList, m_mgrSmallImages.GetImageIndex("AnimatTools.Distribute.gif"))
            Dim mcDistributeVertical As New MenuCommand("Veritcal", "DistributeVertical", _
                                                        m_mgrSmallImages.ImageList, _
                                                        m_mgrSmallImages.GetImageIndex("AnimatTools.DistributeVertical.gif"), _
            ...
            Dim mcDistributeHorizontal As New MenuCommand("Horizontal", "DistributeHorizontal", _
                                                          m_mgrSmallImages.ImageList, _
                                                          m_mgrSmallImages.GetImageIndex("AnimatTools.DistributeHorizontal.gif"), _
            ...
            Dim mcSize As New MenuCommand("Size", "Size", m_mgrSmallImages.ImageList, m_mgrSmallImages.GetImageIndex("AnimatTools.Size.gif"))
            Dim mcSizeBoth As New MenuCommand("Both", "SizeBoth", m_mgrSmallImages.ImageList, _
                                              m_mgrSmallImages.GetImageIndex("AnimatTools.SizeBoth.gif"), _
                                              New EventHandler(AddressOf Me.OnSizeBoth))
            Dim mcSizeWidth As New MenuCommand("Width", "SizeWidth", m_mgrSmallImages.ImageList, _
                                               m_mgrSmallImages.GetImageIndex("AnimatTools.SizeWidth.gif"), _
                                               New EventHandler(AddressOf Me.OnSizeWidth))
            Dim mcSizeHeight As New MenuCommand("Height", "SizeHeight", m_mgrSmallImages.ImageList, _
                                                m_mgrSmallImages.GetImageIndex("AnimatTools.SizeHeight.gif"), _
            ...
            Dim mcInsertPage As New MenuCommand("Insert Page", "InsertPage", m_mgrSmallImages.ImageList, _
                                              m_mgrSmallImages.GetImageIndex("AnimatTools.SizeBoth.gif"), _
                                              New EventHandler(AddressOf Me.OnInsertPage))
            Dim mcAddStim As New MenuCommand("Add Stimulus", "AddStimulus", m_mgrSmallImages.ImageList, _
                                              m_mgrSmallImages.GetImageIndex("AnimatTools.AddStimulus.gif"), _
                                              New EventHandler(AddressOf Me.OnAddStimulus))
            Dim mcSelectByType As New MenuCommand("Select By Type", "SelectByType", m_mgrSmallImages.ImageList, _
                                              m_mgrSmallImages.GetImageIndex("AnimatTools.SelectByType.gif"), _
                                              New EventHandler(AddressOf Me.OnSelectByType))
            Dim mcRelabel As New MenuCommand("Relabel", "Relabel", m_mgrSmallImages.ImageList, _
                                              m_mgrSmallImages.GetImageIndex("AnimatTools.Relabel.gif"), _
                                              New EventHandler(AddressOf Me.OnRelabel))
            Dim mcRelabelSelected As New MenuCommand("Relabel Selected", "RelabelSelected", m_mgrSmallImages.ImageList, _
                                              m_mgrSmallImages.GetImageIndex("AnimatTools.RelabelSelected.gif"), _
                                              New EventHandler(AddressOf Me.OnRelabelSelected))
            Dim mcShowConnections As New MenuCommand("Show Connections", "ShowConnections", m_mgrSmallImages.ImageList, _
                                              m_mgrSmallImages.GetImageIndex("AnimatTools.Connections.gif"), _
                                              New EventHandler(AddressOf Me.OnShowConnections))
            Dim mcCompareItems As New MenuCommand("Compare Items", "CompareItems", m_mgrSmallImages.ImageList, _
                                              m_mgrSmallImages.GetImageIndex("AnimatTools.Equals.gif"), _
                                              New EventHandler(AddressOf Me.OnCompareItems))
            'Dim mcAutoUpdate As New MenuCommand("Auto Update", "mcAutoUpdate", m_mgrSmallImages.ImageList, _
            ''                                             m_mgrSmallImages.GetImageIndex("AnimatTools.Equals.gif"), _
            '                                             New EventHandler(AddressOf Me.OnAutoUpdate))
            Dim mcSepEditStart As MenuCommand = New MenuCommand("-")
            Dim mcCut As New MenuCommand("Cut", "Cut", m_mgrSmallImages.ImageList, _
                                         m_mgrSmallImages.GetImageIndex("AnimatTools.Cut.gif"), _
                                         Shortcut.CtrlX, New EventHandler(AddressOf Me.OnCut))
            Dim mcCopy As New MenuCommand("Copy", "Copy", m_mgrSmallImages.ImageList, _
                                            m_mgrSmallImages.GetImageIndex("AnimatTools.Copy.gif"), _
                                            Shortcut.CtrlC, New EventHandler(AddressOf Me.OnCopy))
            Dim mcPaste As New MenuCommand("Paste", "Paste", m_mgrSmallImages.ImageList, _
                                            m_mgrSmallImages.GetImageIndex("AnimatTools.Paste.gif"), _
                                            Shortcut.CtrlV, New EventHandler(AddressOf Me.OnPaste))
            Dim mcPasteInPlace As New MenuCommand("Paste In Place", "PasteInPlace", m_mgrSmallImages.ImageList, _
                                            m_mgrSmallImages.GetImageIndex("AnimatTools.Paste.gif"), _
                                            Shortcut.CtrlB, New EventHandler(AddressOf Me.OnPasteInPlace))
            Dim mcDelete As New MenuCommand("Delete", "Delete", m_mgrSmallImages.ImageList, _
                                            m_mgrSmallImages.GetImageIndex("AnimatTools.Delete.gif"), _
        ...
        Protected Overrides Sub CreateToolbar()
            ...
            btnZoomIn.ImageIndex = m_frmApplication.LargeImages.GetImageIndex("AnimatTools.ZoomIn.gif")
            ...
            btnZoomOut.ImageIndex = m_frmApplication.LargeImages.GetImageIndex("AnimatTools.ZoomOut.gif")
            ...
            btnAddStimulus.ImageIndex = m_frmApplication.LargeImages.GetImageIndex("AnimatTools.AddStimulus.gif")
            ...
            btnSelectByType.ImageIndex = m_frmApplication.LargeImages.GetImageIndex("AnimatTools.SelectByType.gif")
            btnSelectByType.ToolTipText = "Select Items by Object Type"

            Dim btnRelabel As New ToolBarButton
            btnRelabel.ImageIndex = m_frmApplication.LargeImages.GetImageIndex("AnimatTools.Relabel.gif")
            btnRelabel.ToolTipText = "Relabel items using regular expressions."

            Dim btnRelabelSelected As New ToolBarButton
            btnRelabelSelected.ImageIndex = m_frmApplication.LargeImages.GetImageIndex("AnimatTools.RelabelSelected.gif")
            btnRelabelSelected.ToolTipText = "Relabel and number selected items"

            Dim btnShowConnections As New ToolBarButton
            btnShowConnections.ImageIndex = m_frmApplication.LargeImages.GetImageIndex("AnimatTools.Connections.gif")
            ...
            btnAlign.ImageIndex = m_frmApplication.LargeImages.GetImageIndex("AnimatTools.Align.gif")
            btnAlign.ToolTipText = "Align Nodes"

            Dim btnCompareItem As New ToolBarButton
            btnCompareItem.ImageIndex = m_frmApplication.LargeImages.GetImageIndex("AnimatTools.Equals.gif")
            ...
            btnDistribute.ImageIndex = m_frmApplication.LargeImages.GetImageIndex("AnimatTools.Distribute.gif")
            ...
            btnSize.ImageIndex = m_frmApplication.LargeImages.GetImageIndex("AnimatTools.Size.gif")
        ...
        Protected Overridable Sub CreateImageManager()
            ...
            Try
                ...
                m_mgrSmallImages.AddImage(myAssembly, "AnimatTools.Align.gif")
                m_mgrSmallImages.AddImage(myAssembly, "AnimatTools.AlignGrey.gif")
                m_mgrSmallImages.AddImage(myAssembly, "AnimatTools.AlignBottom.gif")
                m_mgrSmallImages.AddImage(myAssembly, "AnimatTools.AlignBottomGrey.gif")
                m_mgrSmallImages.AddImage(myAssembly, "AnimatTools.AlignHorizontalCenter.gif")
                m_mgrSmallImages.AddImage(myAssembly, "AnimatTools.AlignHorizontalCenterGrey.gif")
                m_mgrSmallImages.AddImage(myAssembly, "AnimatTools.AlignLeft.gif")
                m_mgrSmallImages.AddImage(myAssembly, "AnimatTools.AlignLeftGrey.gif")
                m_mgrSmallImages.AddImage(myAssembly, "AnimatTools.AlignRight.gif")
                m_mgrSmallImages.AddImage(myAssembly, "AnimatTools.AlignRightGrey.gif")
                m_mgrSmallImages.AddImage(myAssembly, "AnimatTools.AlignTop.gif")
                m_mgrSmallImages.AddImage(myAssembly, "AnimatTools.AlignTopGrey.gif")
                m_mgrSmallImages.AddImage(myAssembly, "AnimatTools.AlignVerticalCenter.gif")
                m_mgrSmallImages.AddImage(myAssembly, "AnimatTools.AlignVerticalCenterGrey.gif")
                m_mgrSmallImages.AddImage(myAssembly, "AnimatTools.Distribute.gif")
                m_mgrSmallImages.AddImage(myAssembly, "AnimatTools.DistributeGrey.gif")
                m_mgrSmallImages.AddImage(myAssembly, "AnimatTools.DistributeHorizontal.gif")
                m_mgrSmallImages.AddImage(myAssembly, "AnimatTools.DistributeHorizontalGrey.gif")
                m_mgrSmallImages.AddImage(myAssembly, "AnimatTools.DistributeVertical.gif")
                m_mgrSmallImages.AddImage(myAssembly, "AnimatTools.DistributeVerticalGrey.gif")
                m_mgrSmallImages.AddImage(myAssembly, "AnimatTools.Size.gif")
                m_mgrSmallImages.AddImage(myAssembly, "AnimatTools.SizeGrey.gif")
                m_mgrSmallImages.AddImage(myAssembly, "AnimatTools.SizeBoth.gif")
                m_mgrSmallImages.AddImage(myAssembly, "AnimatTools.SizeBothGrey.gif")
                m_mgrSmallImages.AddImage(myAssembly, "AnimatTools.SizeHeight.gif")
                m_mgrSmallImages.AddImage(myAssembly, "AnimatTools.SizeHeightGrey.gif")
                m_mgrSmallImages.AddImage(myAssembly, "AnimatTools.SizeWidth.gif")
                m_mgrSmallImages.AddImage(myAssembly, "AnimatTools.SizeWidthGrey.gif")
                m_mgrSmallImages.AddImage(myAssembly, "AnimatTools.ZoomIn.gif")
                m_mgrSmallImages.AddImage(myAssembly, "AnimatTools.ZoomOut.gif")
                m_mgrSmallImages.AddImage(myAssembly, "AnimatTools.PageSetup.gif")
                ...
                m_mgrSmallImages.AddImage(myAssembly, "AnimatTools.SendToBack.gif")
                m_mgrSmallImages.AddImage(myAssembly, "AnimatTools.BringToFront.gif")
                ...
                m_mgrSmallImages.AddImage(myAssembly, "AnimatTools.Wrench_Small.gif")
                m_mgrSmallImages.AddImage(myAssembly, "AnimatTools.Properties.gif")
                m_mgrSmallImages.AddImage(myAssembly, "AnimatTools.Neuron.gif")
                m_mgrSmallImages.AddImage(myAssembly, "AnimatTools.Error_Small.gif")
                m_mgrSmallImages.AddImage(myAssembly, "AnimatTools.ExternalStimulus.gif")
                m_mgrSmallImages.AddImage(myAssembly, "AnimatTools.AddStimulus.gif")
                m_mgrSmallImages.AddImage(myAssembly, "AnimatTools.SelectByType.gif")
                m_mgrSmallImages.AddImage(myAssembly, "AnimatTools.Relabel.gif")
                m_mgrSmallImages.AddImage(myAssembly, "AnimatTools.RelabelSelected.gif")
                m_mgrSmallImages.AddImage(myAssembly, "AnimatTools.Connections.gif")
                m_mgrSmallImages.AddImage(myAssembly, "AnimatTools.Equals.gif")

                'm_frmApplication.LargeImages.AddImage(myAssembly, "AnimatTools.AlignLarge.gif")
                'm_frmApplication.LargeImages.AddImage(myAssembly, "AnimatTools.AlignGreyLarge.gif")
                'm_frmApplication.LargeImages.AddImage(myAssembly, "AnimatTools.DistributeLarge.gif")
                'm_frmApplication.LargeImages.AddImage(myAssembly, "AnimatTools.DistributeGreyLarge.gif")
                'm_frmApplication.LargeImages.AddImage(myAssembly, "AnimatTools.SizeLarge.gif")
                'm_frmApplication.LargeImages.AddImage(myAssembly, "AnimatTools.SizeGreyLarge.gif")
                m_frmApplication.LargeImages.AddImage(myAssembly, "AnimatTools.ZoomIn.gif")
                m_frmApplication.LargeImages.AddImage(myAssembly, "AnimatTools.ZoomOut.gif")
                m_frmApplication.LargeImages.AddImage(myAssembly, "AnimatTools.AddStimulus.gif")
                m_frmApplication.LargeImages.AddImage(myAssembly, "AnimatTools.Delete.gif")
                m_frmApplication.LargeImages.AddImage(myAssembly, "AnimatTools.Align.gif")
                m_frmApplication.LargeImages.AddImage(myAssembly, "AnimatTools.Distribute.gif")
                m_frmApplication.LargeImages.AddImage(myAssembly, "AnimatTools.Size.gif")
                m_frmApplication.LargeImages.AddImage(myAssembly, "AnimatTools.SelectByType.gif")
                m_frmApplication.LargeImages.AddImage(myAssembly, "AnimatTools.Relabel.gif")
                m_frmApplication.LargeImages.AddImage(myAssembly, "AnimatTools.RelabelSelected.gif")
                m_frmApplication.LargeImages.AddImage(myAssembly, "AnimatTools.Connections.gif")
                m_frmApplication.LargeImages.AddImage(myAssembly, "AnimatTools.Equals.gif")
...
#End Region
        ...
        Protected Overridable Sub CreateIconBands()
            ...
            Try
                ...
                For Each pdPanel As DataObjects.Behavior.PanelData In m_frmApplication.AlphabeticalBehavioralPanels
                    ...
                    For Each bnNode As DataObjects.Behavior.Node In pdPanel.m_aryNodes
                        ...
                        ipPanel.AddIcon(bnNode.Name, bnNode.Image, bnNode.DragImage, bnNode)
        ...
        Public Overridable Function SelectLinkType(ByRef bnOrigin As DataObjects.Behavior.Node, ByRef bnDestination As DataObjects.Behavior.Node, _
            ...
            Else
                ...
                ElseIf aryCompatibleLinks.Count = 1 Then
                    ...
                    If TypeOf (blLink) Is AnimatTools.DataObjects.Behavior.Links.Adapter Then
        ...
        Public Overridable Function CreateDiagram(ByVal strAssemblyName As String, ByVal strClassName As String, _
            ...
            Dim bdDiagram As Forms.Behavior.Diagram = DirectCast(m_frmApplication.CreateForm(strAssemblyName, _
                                                                 strClassName, "Page", Me, False), _
                                                                 Forms.Behavior.Diagram)
            Dim afDiagram As AnimatForm = DirectCast(bdParent, AnimatForm)
            bdDiagram.Initialize(m_frmApplication, Me, afDiagram)
        ...
        Public Overridable Sub SelectDataItem(ByVal doItem As AnimatTools.DataObjects.Behavior.Data, Optional ByVal bOnlyItemSelected As Boolean = True)
            ...
            Else
                If Not doItem Is Nothing Then
                    ...
                    Dim aryItems(m_arySelectedObjects.Count - 1) As PropertyBag
                    Dim iIndex As Integer = 0
                    For Each doSelPart As AnimatTools.DataObjects.Behavior.Data In m_arySelectedObjects
...
#Region " Load/Save "
        ...
        Public Overridable Overloads Sub LoadEditorFile(ByVal strFilename As String)
            Try
                ...
                oXml.Load(Util.GetFilePath(m_frmApplication.ProjectPath, strFilename))
        ...
        Protected Overridable Overloads Sub LoadEditorFile(ByRef oXml As AnimatTools.Interfaces.StdXml)
            ...
            Try
                If m_frmApplication.Simulation Is Nothing Then
                ...
                Me.Organism = DirectCast(m_frmApplication.Simulation.Environment.Organisms(strOrganism), DataObjects.Physical.Organism)
                ...
                m_frmApplication.LoadDockingConfig(m_dockManager, oXml)
        ...
        Protected Overridable Sub LoadDiagramImages(ByRef oXml As AnimatTools.Interfaces.StdXml)
        ...
        Protected Overridable Overloads Sub SaveEditorFile(ByVal strFilename As String)
            ...
            Try
                ...
                SaveEditorFile(oXml)
                oXml.Save(Util.GetFilePath(m_frmApplication.ProjectPath, strFilename))
        ...
        Protected Overridable Overloads Sub SaveEditorFile(ByRef oXml As AnimatTools.Interfaces.StdXml)
            ...
            Try
                ...
                m_frmApplication.SaveDockingConfig(m_dockManager, oXml)
        ...
        Protected Overridable Sub SaveNeuralModules(ByRef oXml As AnimatTools.Interfaces.StdXml)
        ...
        Protected Overridable Sub SaveDiagrams(ByRef oXml As AnimatTools.Interfaces.StdXml)
        ...
        Protected Overridable Sub SaveDiagramImages(ByRef oXml As AnimatTools.Interfaces.StdXml)
...
#Region " Events "
        ...
        Protected Sub OnInsertPage(ByVal sender As Object, ByVal e As System.EventArgs)
            ...
            Try
                AddDiagram("LicensedAnimatTools.dll", "LicensedAnimatTools.Forms.Behavior.AddFlowDiagram", Nothing)
            Catch ex As System.Exception
                AnimatTools.Framework.Util.DisplayError(ex)
            End Try
        ...
        Public Overrides Sub UndoRedoRefresh(ByVal oRefresh As Object)
            ...
            If Not oRefresh Is Nothing Then
                Dim doRefresh As AnimatTools.Framework.DataObject

                If TypeOf oRefresh Is AnimatTools.Framework.DataObject Then
                    doRefresh = DirectCast(oRefresh, AnimatTools.Framework.DataObject)
                End If

                If TypeOf oRefresh Is AnimatTools.DataObjects.Behavior.Data Then
                    Dim doData As AnimatTools.DataObjects.Behavior.Data = DirectCast(oRefresh, AnimatTools.DataObjects.Behavior.Data)
                ...
                ElseIf Not doRefresh Is Nothing AndAlso Not doRefresh.Parent Is Nothing AndAlso TypeOf doRefresh.Parent Is AnimatTools.DataObjects.Behavior.Data Then
                    Dim doData As AnimatTools.DataObjects.Behavior.Data = DirectCast(doRefresh.Parent, AnimatTools.DataObjects.Behavior.Data)
                    ...
                    Else
                        doData.ParentDiagram.SelectDataItem(doData)
                    End If
                ElseIf Not doRefresh Is Nothing AndAlso TypeOf doRefresh Is AnimatTools.DataObjects.Behavior.NeuralModule Then
