...
#Region " Methods "
        ...
        Public Overrides Sub Initialize(ByRef frmApplication As AnimatApplication, _
            ...
            Try
                ...
                m_imgManager.AddImage(myAssembly, "AnimatTools.Organism.gif")
                m_imgManager.AddImage(myAssembly, "AnimatTools.DefaultObject.gif")
                m_imgManager.AddImage(myAssembly, "AnimatTools.DefaultLink.gif")
                ...
                m_tnRoot.ImageIndex = m_imgManager.GetImageIndex("AnimatTools.Organism.gif")
                m_tnRoot.SelectedImageIndex = m_imgManager.GetImageIndex("AnimatTools.Organism.gif")
                ...
                Try
                    ...
                    For Each doNode In Util.Application.BehavioralNodes
                        If doNode.ImageName.Trim.Length > 0 Then
                            m_imgManager.AddImage(doNode.ImageName, doNode.Image)
                            m_dragImageManager.AddImage(doNode.ImageName, doNode.DragImage, System.Drawing.Color.Transparent)
                        End If
                    Next

                    Dim doLink As DataObjects.Behavior.Link
                    For Each doLink In Util.Application.BehavioralLinks
                        If doLink.ImageName.Trim.Length > 0 Then
                            m_imgManager.AddImage(doLink.ImageName, doLink.Image)
                            m_dragImageManager.AddImage(doLink.ImageName, doLink.DragImage, System.Drawing.Color.Transparent)
                        End If
                    Next
        ...
        Public Overridable Function AddDiagram(ByVal tnParentNode As TreeNode, ByVal bdDiagram As Behavior.Diagram) As TreeNode
            ...
            m_imgManager.AddImage(bdDiagram.ImageName, bdDiagram.Image)
            bdDiagram.DiagramTreeNode.ImageIndex = m_imgManager.GetImageIndex(bdDiagram.ImageName)
            bdDiagram.DiagramTreeNode.SelectedImageIndex = m_imgManager.GetImageIndex(bdDiagram.ImageName)

            'Now add the nodes and links tree nodes
            bdDiagram.NodesTreeNode = tnNode.Nodes.Add("Nodes")
            bdDiagram.NodesTreeNode.ImageIndex = m_imgManager.GetImageIndex("AnimatTools.DefaultObject.gif")
            bdDiagram.NodesTreeNode.SelectedImageIndex = m_imgManager.GetImageIndex("AnimatTools.DefaultObject.gif")

            bdDiagram.LinksTreeNode = tnNode.Nodes.Add("Links")
            bdDiagram.LinksTreeNode.ImageIndex = m_imgManager.GetImageIndex("AnimatTools.DefaultLink.gif")
            bdDiagram.LinksTreeNode.SelectedImageIndex = m_imgManager.GetImageIndex("AnimatTools.DefaultLink.gif")
        ...
        Private Sub ctrlTreeView_AfterSelect(ByVal sender As Object, ByVal e As System.Windows.Forms.TreeViewEventArgs) Handles ctrlTreeView.AfterSelect
            Try
                ...
                If Not e.Node Is Nothing AndAlso Not e.Node.Tag Is Nothing Then
                    If TypeOf e.Node.Tag Is AnimatTools.Forms.Behavior.Diagram Then
                        Dim bdDiagram As Behavior.Diagram = DirectCast(e.Node.Tag, Behavior.Diagram)
                        m_beEditor.SelectedDiagram(bdDiagram)
                    ElseIf TypeOf e.Node.Tag Is AnimatTools.DataObjects.Behavior.Data Then
                        Dim doData As AnimatTools.DataObjects.Behavior.Data = DirectCast(e.Node.Tag, AnimatTools.DataObjects.Behavior.Data)
        ...
        Private Sub ctrlTreeView_MouseDown(ByVal sender As Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles ctrlTreeView.MouseDown
            ...
            Try
                If e.Button = MouseButtons.Right Then
                    ...
                    If Not tnSelected.Tag Is Nothing AndAlso (TypeOf tnSelected.Tag Is AnimatTools.Forms.Behavior.Editor OrElse TypeOf tnSelected.Tag Is AnimatTools.Forms.Behavior.Diagram) Then
                    ...
                    If Not tndNode Is Nothing AndAlso Not tndNode.Tag Is Nothing _
                       AndAlso TypeOf tndNode.Tag Is DataObjects.Behavior.Data Then
                        ...
                        If doData.CanBeCharted Then
                            ...
                            m_imageDrag.StartDrag(m_dragImageManager.GetImageIndex(doData.ImageName), CInt(m_szDragImageSize.Width / 2), CInt(m_szDragImageSize.Height / 2))
        ...
        Protected Sub OnInsertDiagram(ByVal sender As Object, ByVal e As System.EventArgs)
            ...
            Try
                ...
                If Not tnSelected.Tag Is Nothing AndAlso TypeOf (tnSelected.Tag) Is Behavior.Diagram Then
                    ...
                    bdDiagram.AddDiagram("LicensedAnimatTools.dll", "LicensedAnimatTools.Forms.Behavior.AddFlowDiagram")
                ElseIf tnSelected Is m_tnRoot Then
                    m_beEditor.AddDiagram("LicensedAnimatTools.dll", "LicensedAnimatTools.Forms.Behavior.AddFlowDiagram", Nothing)
                End If
