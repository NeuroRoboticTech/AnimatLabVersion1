...
#Region " Attributes "
        ...
        Protected m_doNode As AnimatTools.DataObjects.Behavior.Node
        Protected m_doSelectedNode As AnimatTools.DataObjects.Behavior.Node
        Protected m_doSelectedLink As AnimatTools.DataObjects.Behavior.Link
...
#Region " Properties "
        ...
        Public Overridable Property Node() As AnimatTools.DataObjects.Behavior.Node
            Get
                Return m_doNode
            End Get
        ...
        Public Overridable ReadOnly Property SelectedNode() As AnimatTools.DataObjects.Behavior.Node
            Get
                Return m_doSelectedNode
            End Get
        End Property

        Public Overridable ReadOnly Property SelectedLink() As AnimatTools.DataObjects.Behavior.Link
            Get
...
#Region " Methods "
        ...
        Protected Sub BuildDataArray(ByVal bInLinks As Boolean, ByVal aryData As AnimatTools.Collections.SortedLinks, ByVal grdData As DataGrid, ByVal aryCol As Collection)
            ...
            For Each deEntry As DictionaryEntry In aryData
                doLink = DirectCast(deEntry.Value, AnimatTools.DataObjects.Behavior.Link)
                aryCol.Add(doLink)
...
#Region " Events "
        ...
        Private Sub grdInputs_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles grdInputs.DoubleClick
            ...
            Try
                Dim doLink As AnimatTools.DataObjects.Behavior.Link = DirectCast(m_aryInLinks(grdInputs.CurrentCell.RowNumber + 1), AnimatTools.DataObjects.Behavior.Link)
        ...
        Private Sub grdOutputs_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles grdOutputs.DoubleClick
            ...
            Try
                Dim doLink As AnimatTools.DataObjects.Behavior.Link = DirectCast(m_aryOutLinks(grdOutputs.CurrentCell.RowNumber + 1), AnimatTools.DataObjects.Behavior.Link)
