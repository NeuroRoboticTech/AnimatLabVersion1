...
#Region " Events "
        ...
        Protected Overrides Sub OnLoad(ByVal e As System.EventArgs)
            ...
            Try
                ...
                Dim imgDefault As Image = ImageManager.LoadImage(myAssembly, "AnimatTools.DefaultLink.gif")
                ...
                m_mgrIconImages = New AnimatTools.Framework.ImageManager
                For Each blLink As DataObjects.Behavior.Link In m_aryCompatibleLinks
                    If Not blLink.Image Is Nothing AndAlso Not TypeOf (blLink) Is AnimatTools.DataObjects.Behavior.Links.Adapter Then
                        If blLink.Image.Width > iMaxWidth Then iMaxWidth = blLink.Image.Width
                        If blLink.Image.Height > iMaxHeight Then iMaxHeight = blLink.Image.Height
                    End If
                Next
                ...
                For Each blLink As DataObjects.Behavior.Link In m_aryCompatibleLinks
                    If Not blLink.Image Is Nothing AndAlso Not TypeOf (blLink) Is AnimatTools.DataObjects.Behavior.Links.Adapter Then
                        m_mgrIconImages.AddImage(blLink.Name, blLink.Image)
                    End If
                Next
                ...
                For Each blLink As DataObjects.Behavior.Link In m_aryCompatibleLinks
                    If Not TypeOf (blLink) Is AnimatTools.DataObjects.Behavior.Links.Adapter Then
                        Dim liItem As New ListViewItem
                        liItem.Text = blLink.Name

                        If Not blLink.Image Is Nothing Then
