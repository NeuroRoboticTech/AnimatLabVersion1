...
#Region " Methods "
        ...
        Public Overrides Sub Initialize(ByRef frmApplication As AnimatApplication, _
            ...
            Try
                ...
                m_mgrSmallImages.AddImage(myAssembly, "AnimatTools.ErrorSmall.gif")
                m_mgrSmallImages.AddImage(myAssembly, "AnimatTools.WarningSmall.gif")

                lvErrors.SmallImageList = m_mgrSmallImages.ImageList
