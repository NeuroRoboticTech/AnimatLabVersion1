...
#Region " Attributes "
        ...
        Protected m_doDiagram As AnimatTools.Forms.Behavior.Diagram
            ...
            Try
                ...
                For Each deEntry As DictionaryEntry In m_aryInitialTypeList
                    ...
                    While Not bDone
                        ...
                        If Not tpType.BaseType Is Nothing AndAlso Not tpType.BaseType.FullName = "AnimatTools.DataObjects.Behavior.Data" Then
