...
#Region " Attributes "
        ...
        Protected m_bnParentDiagram As AnimatTools.Forms.Behavior.Diagram
        ...
        Protected m_aryNodes As New AnimatTools.Collections.AnimatSortedList(Me.FormHelper)
        Protected m_aryLinks As New AnimatTools.Collections.AnimatSortedList(Me.FormHelper)
...
#Region " Properties "
        ...
        Public Overrides ReadOnly Property IconName() As String
            Get
                Return "AnimatTools.SubsystemNode.gif"
            End Get
        End Property
        ...
        Public Overridable ReadOnly Property Nodes() As AnimatTools.Collections.AnimatSortedList
            Get
                Return m_aryNodes
            End Get
        End Property

        Public Overridable ReadOnly Property Links() As AnimatTools.Collections.AnimatSortedList
            Get
                Return m_aryLinks
            End Get
        End Property
...
#Region " Methods "
        ...
        Public Overridable Sub SelectByType()
            Try
                Dim frmType As New AnimatTools.Forms.Behavior.SelectByType
        ...
        Public Overridable Sub Relabel()
            Dim frmRelabel As New AnimatTools.Forms.Behavior.Relabel
        ...
        Public Shared Sub InitializeDataAfterLoad(ByRef aryData As AnimatTools.Collections.AnimatSortedList)
        ...
        Protected Shared Sub InitializeDataAfterLoad(ByRef aryItems As AnimatTools.Collections.BehaviorItems)

            Dim aryFailed As New AnimatTools.Collections.BehaviorItems(Nothing)
            ...
            For Each bdData In aryItems
                bdData.InitializeAfterLoad(iAttempt)
        ...
        Public MustOverride Sub SetItemsTempID(ByVal bdItem As AnimatTools.DataObjects.Behavior.Data, ByVal strID As String)
        ...
        Public MustOverride Function SaveSelected(ByRef oXml As AnimatTools.Interfaces.StdXml, ByVal bCopy As Boolean) As Boolean
        Public MustOverride Sub LoadSelected(ByRef oXml As AnimatTools.Interfaces.StdXml, ByVal bInPlace As Boolean)
