...
Imports AnimatTools.DataObjects.Physical
...
#Region " Attributes "
        ...
        Protected m_eDistanceUnits As AnimatTools.DataObjects.Physical.Environment.enumDistanceUnits
        Protected m_eMassUnits As AnimatTools.DataObjects.Physical.Environment.enumMassUnits

#End Region

#Region " Properties "

        Public Property DistanceUnits() As AnimatTools.DataObjects.Physical.Environment.enumDistanceUnits
            Get
        ...
        Public Property MassUnits() As AnimatTools.DataObjects.Physical.Environment.enumMassUnits
            Get
                Return m_eMassUnits
            End Get
...
#Region " Methods "
        ...
        Private Sub btnOk_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnOk.Click
            Try
                ...
                m_eDistanceUnits = DirectCast([Enum].Parse(GetType(AnimatTools.DataObjects.Physical.Environment.enumDistanceUnits), DirectCast(cboDistanceUnits.SelectedItem, String), True), AnimatTools.DataObjects.Physical.Environment.enumDistanceUnits)
                m_eMassUnits = DirectCast([Enum].Parse(GetType(AnimatTools.DataObjects.Physical.Environment.enumMassUnits), DirectCast(cboMassUnits.SelectedItem, String), True), AnimatTools.DataObjects.Physical.Environment.enumMassUnits)
