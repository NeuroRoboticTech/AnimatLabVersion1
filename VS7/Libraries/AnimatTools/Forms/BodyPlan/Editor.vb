...
#Region " Attributes "
        ...
        Protected m_CommandBar As Forms.BodyPlan.Command
        Protected m_CommandContent As Content
        Protected m_mcCommandBar As MenuCommand
...
#Region " Properties "
        ...
        Public Overridable ReadOnly Property CommandBar() As Forms.BodyPlan.Command
            Get
                Return m_CommandBar
            End Get
        End Property
        ...
        Public Overridable Property MouseSensitivity() As Single
            ...
            Set(ByVal Value As Single)
                ...
                If Not Me.CommandBar Is Nothing AndAlso Not Me.CommandBar.txtSensitivity Is Nothing Then
                    Me.CommandBar.txtSensitivity.Text = m_fltMouseSensitivity.ToString()
                End If
            End Set
        End Property
...
#Region " Methods "
        ...
        Public Overrides Sub Initialize(ByVal frmApplication As AnimatApplication, _
            ...
            Try
                ...
                Dim afDiagram As AnimatForm = m_frmApplication.CreateForm("VortexAnimatTools.dll", _
                                                                        "VortexAnimatTools.Forms.BodyPlan.BodyViewD3D", _
                                                                        "Body View", Me, False)
                CreateImageManager()
                ...
                m_ReceptiveFieldsBar = DirectCast(m_frmApplication.CreateForm("VortexAnimatTools.dll", _
                                                    "VortexAnimatTools.Forms.BodyPlan.ReceptiveFields", _
                                                    "Receptive Fields", Me, False), AnimatTools.Forms.BodyPlan.ReceptiveFields)
                m_ReceptiveFieldsBar.Initialize(m_frmApplication, Me)

                m_ReceptiveFieldsBar.Location = New Point(0, 0)
                m_ReceptiveFieldsContent = m_dockManager.Contents.Add(m_ReceptiveFieldsBar, "Receptive Fields", m_mgrSmallImages.ImageList, m_mgrSmallImages.GetImageIndex("AnimatTools.ReceptiveField.gif"))
                ...
                m_CommandBar = New AnimatTools.Forms.BodyPlan.Command
                m_CommandBar.Initialize(m_frmApplication, Me)

                m_CommandBar.Location = New Point(0, 0)
                m_CommandContent = m_dockManager.Contents.Add(m_CommandBar, "Command", m_mgrSmallImages.ImageList, m_mgrSmallImages.GetImageIndex("AnimatTools.Wrench_Small.gif"))
                m_CommandContent.DisplaySize = New Size(150, 80)
                m_CommandContent.AutoHideSize = New Size(150, 80)
                m_CommandContent.UserData = m_CommandBar
                m_CommandBar.Content = m_CommandContent

                m_dockManager.AddContentWithState(m_CommandContent, State.DockTop)
                ...
                m_aryToolbarMenus.Add(m_CommandContent.Title, m_mcCommandBar)
                ...
                Me.Icon = m_frmApplication.SmallImages.LoadIcon(myAssembly, "AnimatTools.Joint.ico")
                ...
                m_CommandBar.OnAfterMdiParentInitialized()
...
#Region " Menu/Toolbar Methods "
        ...
        Protected Overrides Sub CreateMenu()
            ...
            m_mcCommandBar = New MenuCommand("Command", "Command", New EventHandler(AddressOf Me.OnViewCommandBar))
            ...
            m_mcCommandBar.Checked = True
            m_mcHierarchyBar.Checked = True
            m_mcPropertiesBar.Checked = True
            m_mcReceptiveFieldsBar.Checked = True

            If Me.PhysicalStructure Is Nothing OrElse (Not Me.PhysicalStructure Is Nothing AndAlso TypeOf Me.PhysicalStructure Is DataObjects.Physical.Organism) Then
                mcToolbars.MenuCommands.AddRange(New MenuCommand() {m_mcCommandBar, m_mcHierarchyBar, m_mcPropertiesBar, m_mcReceptiveFieldsBar})
            Else
                mcToolbars.MenuCommands.AddRange(New MenuCommand() {m_mcCommandBar, m_mcHierarchyBar, m_mcPropertiesBar})
            End If
        ...
        Protected Overridable Sub CreateImageManager()
            ...
            Try
                ...
                Dim vortexAssembly As System.Reflection.Assembly
                vortexAssembly = System.Reflection.Assembly.Load("VortexAnimatTools")
                ...
                m_mgrSmallImages.AddImage(myAssembly, "AnimatTools.ReceptiveField.gif")
                ...
                m_frmApplication.LargeImages.AddImage(myAssembly, "AnimatTools.ZoomInLarge.gif")
                m_frmApplication.LargeImages.AddImage(myAssembly, "AnimatTools.ZoomOutLarge.gif")
...
#Region " Load/Save "
        ...
        Protected Overridable Overloads Sub LoadEditorFile(ByRef oXml As AnimatTools.Interfaces.StdXml)
            ...
            Try
                ...
                Me.PhysicalStructure = DirectCast(m_frmApplication.Simulation.Environment.FindStructureFromAll(strStructure), DataObjects.Physical.PhysicalStructure)
                m_doStructure.BodyEditor = Me
        ...
        Public Overrides Sub SaveData(ByRef oXml As AnimatTools.Interfaces.StdXml)
            ...
            SaveNetworkFile(Me.PhysicalStructure.BodyPlanFile)
            SaveEditorFile(Me.PhysicalStructure.BodyPlanEditorFile)
...
#Region " Events "
        ...
        Public Sub OnCut(ByVal sender As Object, ByVal e As System.EventArgs)
            ...
            Try
                ...
                If Me.PropertiesBar.SelectedParts.Count = 1 AndAlso Not Me.PropertiesBar.SelectedPart Is Nothing AndAlso _
                    TypeOf Me.PropertiesBar.SelectedPart Is AnimatTools.DataObjects.Physical.RigidBody Then
                    Me.PropertiesBar.SelectedPart.DeleteBodyPart(False)
                End If
...
#Region " Toolbar View Events "
        ...
        Protected Sub OnViewCommandBar(ByVal sender As Object, ByVal e As System.EventArgs)
            ViewToolbar(m_CommandContent)
        End Sub
