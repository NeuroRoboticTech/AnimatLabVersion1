...
#Region " Attributes "
        ...
        Protected m_doRootNode As AnimatTools.DataObjects.Physical.BodyPart
...
#Region " Properties "
        ...
        Public Overridable Property RootNode() As AnimatTools.DataObjects.Physical.BodyPart
            Get
                Return m_doRootNode
            End Get
        ...
        Private Sub btnReplace_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnReplace.Click
            ...
            Try
                ...
                If m_doRootNode Is Nothing Then
                    m_doStructure.FindChildrenOfType(GetType(AnimatTools.DataObjects.Physical.BodyPart), aryColObjs)
                Else

                    'If this is a joint then you really want to move from its parent down.
                    If TypeOf m_doRootNode Is AnimatTools.DataObjects.Physical.Joint Then
                        Dim doJoint As AnimatTools.DataObjects.Physical.Joint = DirectCast(m_doRootNode, AnimatTools.DataObjects.Physical.Joint)

                        If Not doJoint.Parent Is Nothing Then
                            m_doRootNode = DirectCast(doJoint.Parent, AnimatTools.DataObjects.Physical.BodyPart)
                        End If
                    End If

                    m_doRootNode.FindChildrenOfType(GetType(AnimatTools.DataObjects.Physical.BodyPart), aryColObjs)
                End If
