            ...
            Try
                ...
                Try
                    ...
                    For Each doPart In Util.Application.BodyPartTypes
                        If doPart.ImageName.Trim.Length > 0 Then
                            m_imgManager.AddImage(doPart.ImageName, doPart.Image)
                            m_dragImageManager.AddImage(doPart.ImageName, doPart.DragImage, System.Drawing.Color.Transparent)
                        End If
                    Next
                    ...
                    If Not tndNode Is Nothing AndAlso Not tndNode.Tag Is Nothing _
                       AndAlso TypeOf tndNode.Tag Is DataObjects.Physical.BodyPart Then
                        ...
                        If doPart.CanBeCharted Then
                            ...
                            m_imageDrag.StartDrag(m_dragImageManager.GetImageIndex(doPart.ImageName), CInt(m_szDragImageSize.Width / 2), CInt(m_szDragImageSize.Height / 2))
