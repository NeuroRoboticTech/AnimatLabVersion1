...
Namespace Forms.BodyPlan
    ...
    Public Class Properties
        Inherits AnimatTools.Forms.Properties
        ...
        Protected Overridable Sub DeselectPart(ByVal doPart As AnimatTools.DataObjects.Physical.BodyPart)
            ...
            If Not Me.Editor.HierarchyBar.TreeView.SelectedNode Is Nothing Then
                ...
                ElseIf Not Me.Editor.HierarchyBar.TreeView.SelectedNode.Tag Is m_doSelectedPart Then
                    Me.Editor.HierarchyBar.TreeView.SelectedNode = m_doSelectedPart.BodyPlanTreeNode
                End If
        ...
        Public Overridable Sub SelectPart(ByVal doPart As AnimatTools.DataObjects.Physical.BodyPart, ByVal bCtrlDown As Boolean)
            ...
            Try
                ...
                If Not m_doSelectedPart Is Nothing Then
                    ...
                    'If it is in the wrong selection command mode then switch it for this body type.
                    If TypeOf m_doSelectedPart Is AnimatTools.DataObjects.Physical.RigidBody Then
                        If Me.Editor.CommandBar.CommandMode = Command.enumCommandMode.SelectJoints Then
                            Me.Editor.CommandBar.CommandMode = Command.enumCommandMode.SelectBodies
                        End If
                    Else
                        If Me.Editor.CommandBar.CommandMode = Command.enumCommandMode.SelectBodies OrElse _
                           Me.Editor.CommandBar.CommandMode = Command.enumCommandMode.SelectReceptiveFields Then
                            Me.Editor.CommandBar.CommandMode = Command.enumCommandMode.SelectJoints
                        End If
                    End If

                    m_doSelectedPart.Selected = True

                    If Not m_doSelectedPart.BodyPlanTreeNode Is Nothing Then
                        Me.Editor.HierarchyBar.TreeView.SelectedNode = m_doSelectedPart.BodyPlanTreeNode
                    End If
