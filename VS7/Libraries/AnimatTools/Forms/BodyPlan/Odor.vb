...
#Region " Methods "
        ...
        Protected Function FindOdorSourceItem(ByVal strTypeID As String) As ListViewItem
            ...
            For Each liItem As ListViewItem In lvOdorSources.Items
                If Not liItem.Tag Is Nothing AndAlso TypeOf liItem.Tag Is AnimatTools.DataObjects.Physical.Odor Then
                    doOdor = DirectCast(liItem.Tag, AnimatTools.DataObjects.Physical.Odor)
