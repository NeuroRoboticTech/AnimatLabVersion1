...
#Region " Events "
        ...
        Protected Overrides Sub OnLoad(ByVal e As System.EventArgs)
            Try
                ...
                m_doStructure.FindChildrenOfType(GetType(AnimatTools.DataObjects.Physical.BodyPart), colObjects)
                ...
                For Each deEntry As DictionaryEntry In m_aryInitialTypeList
                    ...
                    While Not bDone
                        ...
                        If Not tpType.BaseType Is Nothing AndAlso Not tpType.BaseType.FullName = "AnimatTools.DataObjects.DragObject" Then
