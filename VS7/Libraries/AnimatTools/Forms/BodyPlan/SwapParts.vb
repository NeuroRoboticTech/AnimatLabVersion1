...
#End Region
        ...
        Protected m_doExistingPart As AnimatTools.DataObjects.Physical.BodyPart
        Protected m_doNewPart As AnimatTools.DataObjects.Physical.BodyPart
        Protected m_aryPartList As AnimatTools.Collections.BodyParts

        Public Overridable Property ExistingPart() As AnimatTools.DataObjects.Physical.BodyPart
            Get
        ...
        Public Overridable Property NewPart() As AnimatTools.DataObjects.Physical.BodyPart
            Get
                Return m_doNewPart
            End Get
            Set(ByVal Value As AnimatTools.DataObjects.Physical.BodyPart)
        ...
        Public Overridable Property PartList() As AnimatTools.Collections.BodyParts
            Get
                Return m_aryPartList
            End Get
            Set(ByVal Value As AnimatTools.Collections.BodyParts)
                m_aryPartList = Value
            End Set
        End Property
