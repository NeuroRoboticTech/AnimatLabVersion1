...
#Region " Attributes "
        ...
        Protected m_aryCollisionPairs As AnimatTools.Collections.CollisionPairs
        Protected m_aryBodyParts As New AnimatTools.Collections.DataObjects(Nothing)
...
#Region " Properties "
        ...
        Public Property CollisionPairs() As AnimatTools.Collections.CollisionPairs
            Get
...
#Region " Methods "
        ...
        Protected Overrides Sub OnLoad(ByVal e As System.EventArgs)
            ...
            Try
                ...
                If Not m_aryCollisionPairs.Parent Is Nothing AndAlso TypeOf m_aryCollisionPairs.Parent Is AnimatTools.DataObjects.Physical.PhysicalStructure Then
                    Dim doParent As AnimatTools.DataObjects.Physical.PhysicalStructure = DirectCast(m_aryCollisionPairs.Parent, AnimatTools.DataObjects.Physical.PhysicalStructure)

                    doParent.FindChildrenOfType(GetType(AnimatTools.DataObjects.Physical.RigidBody), m_aryBodyParts)

                    'Lets populate the two drop down boxes.
                    Dim doBody As AnimatTools.DataObjects.Physical.RigidBody
                    For Each doPart As AnimatTools.Framework.DataObject In m_aryBodyParts
                        doBody = DirectCast(doPart, AnimatTools.DataObjects.Physical.RigidBody)
...
#Region " Events "
        ...
        Private Sub btnAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAdd.Click
            ...
            Try
                ...
                Dim doPart1 As AnimatTools.DataObjects.Physical.RigidBody = DirectCast(cboBodyPart1.SelectedItem, AnimatTools.DataObjects.Physical.RigidBody)
                Dim doPart2 As AnimatTools.DataObjects.Physical.RigidBody = DirectCast(cboBodyPart2.SelectedItem, AnimatTools.DataObjects.Physical.RigidBody)
                ...
                doPair = New AnimatTools.DataObjects.Physical.CollisionPair(m_aryCollisionPairs.Parent, doPart1, doPart2)
        ...
        Private Sub btnDelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDelete.Click
            ...
            Try
                For Each liItem As ListViewItem In lvCollisionPairs.SelectedItems
                    m_aryCollisionPairs.Remove(DirectCast(liItem.Tag, AnimatTools.DataObjects.Physical.CollisionPair))
                Next
