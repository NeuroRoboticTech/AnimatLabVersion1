...
#Region " Events "
        ...
        Protected Overrides Sub OnLoad(ByVal e As System.EventArgs)
            ...
            Try
                ...
                Dim imgDefault As Image = ImageManager.LoadImage(myAssembly, "AnimatTools.ExternalStimulus.gif")
                ...
                For Each doStimulus As DataObjects.ExternalStimuli.Stimulus In m_aryCompatibleStimuli
                    If Not doStimulus.Image Is Nothing Then
                        If doStimulus.Image.Width > iMaxWidth Then iMaxWidth = doStimulus.Image.Width
                        If doStimulus.Image.Height > iMaxHeight Then iMaxHeight = doStimulus.Image.Height
                    End If
                Next
                ...
                For Each doStimulus As DataObjects.ExternalStimuli.Stimulus In m_aryCompatibleStimuli
                    If Not doStimulus.Image Is Nothing Then
                        m_mgrIconImages.AddImage(doStimulus.ImageName, doStimulus.Image)
                    End If
                Next
                ...
                For Each doStimulus As DataObjects.ExternalStimuli.Stimulus In m_aryCompatibleStimuli
                    ...
                    If Not doStimulus.Image Is Nothing Then
                        liItem.ImageIndex = m_mgrIconImages.GetImageIndex(doStimulus.ImageName)
                    Else
