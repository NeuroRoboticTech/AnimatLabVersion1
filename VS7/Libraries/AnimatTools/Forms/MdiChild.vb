...
#Region " Properties "
        ...
        Public ReadOnly Property MainMenu() As MenuControl
            Get
                Return m_menuMain
            End Get
        End Property

        Public ReadOnly Property MainToolBar() As System.Windows.Forms.ToolBar
            Get
                Return m_barMain
            End Get
        End Property
...
#Region " Methods "
        ...
        Public Overridable Sub Initialize(ByVal frmApplication As AnimatApplication, _
            ...
            If Not m_frmControl Is Nothing Then
                ...
                m_frmControl.Initialize(m_frmApplication, Me, Nothing)
        ...
        Protected Overridable Sub CreateMenu()
            ...
            If m_menuMain Is Nothing Then
                m_menuMain = m_frmApplication.CreateDefaultMenu()
            End If

        End Sub

        Protected Overridable Sub CreateToolbar()
            If m_frmApplication Is Nothing Then Throw New System.Exception("Application object is not defined.")
            If m_frmControl Is Nothing Then Throw New System.Exception("Mdi Control object is not defined.")

            m_barMain = m_frmControl.CreateToolbar(m_menuMain)

            If m_barMain Is Nothing Then
        ...
        Protected Overridable Sub SynchronizeToolbarMenu(ByVal m_aryToolbarMenus As SortedList)
            ...
            For Each ctDock As Content In m_dockManager.Contents
                If TypeOf (ctDock.Control) Is AnimatTools.Forms.AnimatForm Then
        ...
        Protected Overridable Sub LoadWindowSize(ByRef oXml As AnimatTools.Interfaces.StdXml)
        ...
        Public Overridable Sub LoadData(ByRef oXml As AnimatTools.Interfaces.StdXml)
            ...
            If m_frmControl.UseDocking Then
                ...
                For iIndex As Integer = 0 To iCount
                    ...
                    m_frmApplication.LoadDockingForm(m_dockManager, oXml)
                Next
        ...
        Protected Overridable Sub SaveWindowSize(ByRef oXml As AnimatTools.Interfaces.StdXml)
        ...
        Public Overridable Sub SaveData(ByRef oXml As AnimatTools.Interfaces.StdXml)
            ...
            If m_frmControl.UseDocking Then
                ...
                For Each conWindow As Content In m_dockManager.Contents
                    If TypeOf (conWindow.Control) Is AnimatTools.Forms.AnimatForm Then
...
#Region " Events "
        ...
        Protected Sub Mdi_OnEnter(ByVal sender As Object, ByVal e As EventArgs)
            Try
                m_frmApplication.ResetToolbars(m_menuMain, m_barMain)
        ...
        Protected Sub Mdi_OnClick(ByVal sender As Object, ByVal e As EventArgs)
            Try
                If Not m_frmApplication.CurrentMenu Is m_menuMain Then
                    m_frmApplication.ResetToolbars(m_menuMain, m_barMain)
                End If
            Catch ex As System.Exception
                AnimatTools.Framework.Util.DisplayError(ex)
            ...
            Try
                ...
                If Not e.Cancel Then
                    ...
                    If Not m_frmApplication Is Nothing Then
                        ...
                        If m_frmApplication.MdiChildrenCount <= 1 Then
                            m_frmApplication.ResetToolbars()
                        End If
                    End If
                End If
