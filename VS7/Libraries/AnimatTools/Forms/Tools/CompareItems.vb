...
#Region " Attributes "
        ...
        Protected m_doPhysicalStructure As AnimatTools.DataObjects.Physical.PhysicalStructure
        Protected m_arySelectedItems As New AnimatTools.Collections.DataObjects(Nothing)
...
#Region " Properties "
        ...
        Public Property SelectedItems() As AnimatTools.Collections.DataObjects
            Get
                Return m_arySelectedItems
            End Get
            Set(ByVal Value As AnimatTools.Collections.DataObjects)
...
#Region " Methods "
        Public Sub VerifyItemType()
            Dim tpTemplate As Type
                For Each doItem As AnimatTools.Framework.DataObject In m_arySelectedItems
