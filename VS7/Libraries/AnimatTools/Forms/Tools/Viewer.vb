...
#Region " Methods "
        ...
        Public Overrides Sub Initialize(ByVal frmApplication As AnimatApplication, _
            ...
            Try
                ...
                CreateImageManager()
                MyBase.Initialize(frmApplication, frmControl)
                ...
                Me.Icon = m_frmApplication.SmallImages.LoadIcon(myAssembly, "AnimatTools.Wrench.ico")
...
#Region " Menu/Toolbar Methods "
        ...
        Protected Overrides Sub CreateMenu()
            ...
            m_menuMain = m_frmControl.CreateMenu()
        End Sub
...
#Region " Load/Save "
        ...
        Protected Overridable Overloads Sub LoadEditorFile(ByRef oXml As AnimatTools.Interfaces.StdXml)
            ...
            Try
                ...
                m_doToolHolder = Util.Application.ToolHolders(strToolHolder)
