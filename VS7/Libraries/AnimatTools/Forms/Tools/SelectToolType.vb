...
#Region " Events "
        ...
        Protected Overrides Sub OnLoad(ByVal e As System.EventArgs)
            ...
            Try
                ...
                Dim imgDefault As Image = ImageManager.LoadImage(myAssembly, "AnimatTools.Wrench.gif")
                ...
                For Each doTool As Forms.Tools.ToolForm In Util.Application.ToolPlugins
                    If Not doTool.Image Is Nothing Then
                        If doTool.Image.Width > iMaxWidth Then iMaxWidth = doTool.Image.Width
                        If doTool.Image.Height > iMaxHeight Then iMaxHeight = doTool.Image.Height
                    End If
                Next
                ...
                For Each doTool As Forms.Tools.ToolForm In Util.Application.ToolPlugins
                    If Not doTool.Image Is Nothing Then
                        m_mgrIconImages.AddImage(doTool.ImageName, doTool.Image)
                    End If
                Next
                ...
                For Each doTool As Forms.Tools.ToolForm In Util.Application.ToolPlugins
                    ...
                    If Not doTool.Image Is Nothing Then
                        liItem.ImageIndex = m_mgrIconImages.GetImageIndex(doTool.ImageName)
                    Else
