...
#Region " Attributes "
        ...
        Protected m_Gain As AnimatTools.DataObjects.Gain
        ...
        Protected m_ctrlGainChart As AnimatTools.Forms.Gain.GainControl

#End Region

#Region " Properties "

        Public Property Gain() As AnimatTools.DataObjects.Gain
            Get
                Return m_Gain
            End Get
...
#End Region
        ...
        Private Sub EditGain_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            Try
                Dim oAssembly As System.Reflection.Assembly = System.Reflection.Assembly.LoadFrom(Util.GetFilePath(Util.Application.ApplicationDirectory, "LicensedAnimatTools.dll"))
                m_ctrlGainChart = DirectCast(oAssembly.CreateInstance("LicensedAnimatTools.Forms.Charts.GainControl"), AnimatTools.Forms.Gain.GainControl)

                If Not Me.Gain Is Nothing AndAlso Not Me.Gain.Image Is Nothing Then
                    ctrlDiagram.Image = Me.Gain.Image
                Else
        ...
        Protected Overridable Sub LoadGains()
            Dim gnNewGain As AnimatTools.DataObjects.Gain
            ...
            For Each gnGain As DataObjects.Gain In Util.Application.GainTypes
                If gnGain.SelectableGain Then
                    ...
                    ElseIf Not m_Gain Is Nothing Then
                        gnNewGain = DirectCast(gnGain.Clone(m_Gain.Parent, False, Nothing), AnimatTools.DataObjects.Gain)
