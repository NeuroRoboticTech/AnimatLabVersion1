...
#Region " Attributes "
        ...
        Protected m_iNodeIndex As Integer
...
#Region " Properties "
        ...
        <Browsable(False)> _
        Public Overridable Property NodeIndex() As Integer
            Get
                Return m_iNodeIndex
            End Get
            Set(ByVal Value As Integer)
...
#Region " Methods "
        ...
        Protected Overrides Sub CloneInternal(ByVal doOriginal As AnimatTools.Framework.DataObject, ByVal bCutData As Boolean, _
            ...
            m_iNodeIndex = bnOrig.m_iNodeIndex
...
#Region " DataObject Methods "
        ...
        Protected Overrides Sub BuildProperties()
            ...
            'Protected m_iImageIndex As Integer
            'Protected m_ptImageLocation As PointF
            'Protected m_eImagePosition As enumImagePosition
            ...
            m_Properties.Properties.Add(New Crownwood.Magic.Controls.PropertySpec("Alignment", m_eAlignment.GetType(), "Alignment", _
                                        "Graphical Properties", "Sets the alignment style of the text of the node.", m_eAlignment))

            m_Properties.Properties.Add(New Crownwood.Magic.Controls.PropertySpec("AutoSize", m_eAutoSize.GetType(), "AutoSize", _
            ...
            m_Properties.Properties.Add(New Crownwood.Magic.Controls.PropertySpec("Fill Color", m_clFillColor.GetType(), "FillColor", _
            ...
            m_Properties.Properties.Add(New Crownwood.Magic.Controls.PropertySpec("Gradient", m_bGradient.GetType(), "Gradient", _
                                        "Graphical Properties", "Determines whether the node is filled with a linear gradient color.", m_bGradient))

            m_Properties.Properties.Add(New Crownwood.Magic.Controls.PropertySpec("Gradient Color", m_clGradientColor.GetType(), "GradientColor", _
                                        "Graphical Properties", "Sets the color used to draw a gradient with the FillColor.", m_clGradientColor))

            m_Properties.Properties.Add(New Crownwood.Magic.Controls.PropertySpec("Gradient Mode", m_eGradientMode.GetType(), "GradientMode", _
                                        "Graphical Properties", "Sets the direction of the linear gradient when drawn in a node.", m_eGradientMode))

            m_Properties.Properties.Add(New Crownwood.Magic.Controls.PropertySpec("Location", m_ptLocation.GetType(), "Location", _
                                        "Graphical Properties", "Sets or returns the location of the node.", m_ptLocation))

            m_Properties.Properties.Add(New Crownwood.Magic.Controls.PropertySpec("Shadow Style", m_eShadowStyle.GetType(), "ShadowStyle", _
                                        "Graphical Properties", "Sets the shadow style.", m_eShadowStyle))

            m_Properties.Properties.Add(New Crownwood.Magic.Controls.PropertySpec("Shadow Color", m_clShadowColor.GetType(), "ShadowColor", _
                                        "Graphical Properties", "Sets the shadow color.", m_clShadowColor))

            m_Properties.Properties.Add(New Crownwood.Magic.Controls.PropertySpec("Shadow Size", m_szShadowSize.GetType(), "ShadowSize", _
                                        "Graphical Properties", "Sets the shadow size.", m_szShadowSize))

            m_Properties.Properties.Add(New Crownwood.Magic.Controls.PropertySpec("Shape", m_eShape.GetType(), "Shape", _
                                        "Graphical Properties", "Sets the Shape object associated with a node.", m_eShape))

            m_Properties.Properties.Add(New Crownwood.Magic.Controls.PropertySpec("Shape Orientation", m_eShapeOrientation.GetType(), "ShapeOrientation", _
                                        "Graphical Properties", "Sets the shape orientation of the Shape object.", m_eShapeOrientation))

            m_Properties.Properties.Add(New Crownwood.Magic.Controls.PropertySpec("Size", m_szSize.GetType(), "Size", _
            ...
            m_Properties.Properties.Add(New Crownwood.Magic.Controls.PropertySpec("Text Margin", m_szTextMargin.GetType(), "TextMargin", _
            ...
            m_Properties.Properties.Add(New Crownwood.Magic.Controls.PropertySpec("Transparent", m_bTransparent.GetType(), "Transparent", _
                                        "Graphical Properties", "Determines whether the node is transparent or not.", m_bTransparent))

            m_Properties.Properties.Add(New Crownwood.Magic.Controls.PropertySpec("Trimming", m_strTrimming.GetType(), "Trimming", _
            ...
            m_Properties.Properties.Add(New Crownwood.Magic.Controls.PropertySpec("Image", GetType(AnimatTools.DataObjects.Behavior.DiagramImage), "DiagramImage", _
                                        "Graphical Properties", "Assigns an image to this node. ", m_diImage, _
                                        GetType(AnimatTools.TypeHelpers.ImageTypeEditor), _
                                        GetType(AnimatTools.TypeHelpers.ImageTypeConverter)))
        ...
        Public Overrides Sub LoadData(ByRef oXml As AnimatTools.Interfaces.StdXml)
            ...
            Try
                ...
                m_iNodeIndex = oXml.GetChildInt("NodeIndex")
        ...
        Public Overrides Sub SaveData(ByRef oXml As AnimatTools.Interfaces.StdXml)
            ...
            Try
                ...
                oXml.AddChildElement("NodeIndex", m_iNodeIndex)
                ...
                For Each deItem As DictionaryEntry In m_aryInLinks
                    blLink = DirectCast(deItem.Value, AnimatTools.DataObjects.Behavior.Link)
