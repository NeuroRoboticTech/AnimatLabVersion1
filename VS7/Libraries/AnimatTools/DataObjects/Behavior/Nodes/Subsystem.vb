...
#Region " Methods "
        ...
        Public Sub New(ByVal doParent As Framework.DataObject)
            ...
            Try
                ...
                Me.Image = AnimatTools.Framework.ImageManager.LoadImage(myAssembly, "AnimatTools.SubsystemNode.gif")
        ...
        Public Overrides Sub AfterAddNode()
            m_bdSubsystem = m_ParentDiagram.AddDiagram("LicensedAnimatTools.dll", "LicensedAnimatTools.Forms.Behavior.AddFlowDiagram")
