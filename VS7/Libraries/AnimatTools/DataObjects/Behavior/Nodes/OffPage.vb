...
#Region " Properties "
        ...
        Public Overrides ReadOnly Property ImageName() As String
            Get
                Return "AnimatTools.OffPageConnector.gif"
            End Get
        End Property
...
#Region " Methods "
        ...
        Public Sub New(ByVal doParent As Framework.DataObject)
            ...
            Try
                ...
                Me.Image = AnimatTools.Framework.ImageManager.LoadImage(myAssembly, "AnimatTools.OffPageConnector.gif")
...
#Region " DataObject Methods "
        ...
        Protected Overrides Sub BuildProperties()
            ...
            m_Properties.Properties.Add(New Crownwood.Magic.Controls.PropertySpec("Linked Node", GetType(AnimatTools.TypeHelpers.LinkedNode), "LinkedNode", _
                                        "Node Properties", "Sets the node that this associated with this connector.", m_thLinkedNode, _
                                        GetType(AnimatTools.TypeHelpers.DropDownTreeEditor), _
                                        GetType(AnimatTools.TypeHelpers.LinkedNodeTypeConverter)))
