...
#Region " Attributes "
        ...
        Protected m_eLowerScale As AnimatTools.Framework.ScaledNumber.enumNumericScale
        Protected m_dblUpperLimit As Double
        Protected m_eUpperScale As AnimatTools.Framework.ScaledNumber.enumNumericScale
...
#Region " Properties "
        ...
        Public Property LowerLimitscale() As AnimatTools.Framework.ScaledNumber.enumNumericScale
            Get
                Return m_eLowerScale
            End Get
            Set(ByVal Value As AnimatTools.Framework.ScaledNumber.enumNumericScale)
        ...
        Public Property UpperLimitscale() As AnimatTools.Framework.ScaledNumber.enumNumericScale
            Get
        ...
        Public ReadOnly Property LimitText() As String
            Get
                Dim snLower As New AnimatTools.Framework.ScaledNumber(Nothing, "", m_dblLowerLimit, m_eLowerScale, m_strUnits, m_strUnitAbbrev)
                Dim snUpper As New AnimatTools.Framework.ScaledNumber(Nothing, "", m_dblUpperLimit, m_eUpperScale, m_strUnits, m_strUnitAbbrev)
...
#Region " Methods "
        ...
        Public Sub New(ByVal strID As String, ByVal strName As String, ByVal strUnits As String, ByVal strUnitAbbrev As String, _
                       ...
                       ByVal eLowerScale As AnimatTools.Framework.ScaledNumber.enumNumericScale, _
                       ByVal eUpperScale As AnimatTools.Framework.ScaledNumber.enumNumericScale)
            MyBase.New(Nothing)
