...
#Region " Methods "
        ...
        Public Sub ResetStartBits()
            ...
            If Not m_tnNode Is Nothing Then
                ...
                Dim doSelectedController As DataObjects.Physical.Microcontroller
                Dim doSelectedData As DataObjects.Physical.IODataEntry
        ...
        Protected Overrides Sub BuildProperties()
            ...
            m_Properties.Properties.Add(New Crownwood.Magic.Controls.PropertySpec("Output Array Size", m_iOutputArraySize.GetType(), "OutputArraySize", _
                                        "Controller Properties", "The size of the motor Output array in bytes.", m_iOutputArraySize, True))

            m_Properties.Properties.Add(New Crownwood.Magic.Controls.PropertySpec("Comm Port", m_iCommPort.GetType(), "CommPort", _
                                        "Controller Properties", "The number of the comm port that is used to communicate with this microcontroller.", m_iCommPort))

            m_Properties.Properties.Add(New Crownwood.Magic.Controls.PropertySpec("Baud Rate", m_iBaudRate.GetType(), "BaudRate", _
                                        "Controller Properties", "The baud rate used for communications with this microcontroller.", m_iBaudRate))

            m_Properties.Properties.Add(New Crownwood.Magic.Controls.PropertySpec("Byte Size", m_iByteSize.GetType(), "ByteSize", _
                                        "Controller Properties", "The byte size used for communications with this microcontroller.", m_iByteSize))

            m_Properties.Properties.Add(New Crownwood.Magic.Controls.PropertySpec("Stop Bits", m_eStopBits.GetType(), "StopBits", _
                                        "Controller Properties", "The stop bits used for communications with this microcontroller.", m_eStopBits))

            m_Properties.Properties.Add(New Crownwood.Magic.Controls.PropertySpec("Parity", m_eParity.GetType(), "Parity", _
                                        "Controller Properties", "The parity used for communications with this microcontroller.", m_eParity))

            m_Properties.Properties.Add(New Crownwood.Magic.Controls.PropertySpec("Max Motor Updates Per Sec", m_iMaxMotorUpdatesPerSec.GetType(), "MaxMotorUpdatesPerSec", _
        ...
        Public Overridable Overloads Sub SaveData(ByRef dsSim As Simulation, ByRef doStructure As DataObjects.Physical.PhysicalStructure, ByRef oXml As Interfaces.StdXml)
            ...
            If m_aryInputs.Count > 0 Then
                ...
                oXml.IntoElem()
                For Each doData As DataObjects.Physical.IODataEntry In m_aryInputs
                    doData.SaveData(dsSim, doStructure, oXml)
                Next
                oXml.OutOfElem()
            End If
            ...
            Try
                ...
                If oXml.FindChildElement("Inputs", False) Then
                    ...
                    For iIndex As Integer = 0 To iCount
                        ...
                        doData.LoadData(dsSim, doStructure, oXml)
                        doData.OutputEntry = False
