...
#Region " Methods "
        ...
        Protected Overrides Sub BuildProperties()
            ...
            m_Properties.Properties.Add(New Crownwood.Magic.Controls.PropertySpec("Start Bit", m_iStartBit.GetType(), "StartBit", _
                                        "Data Properties", "Determines the starting bit within the I/O array for this data item.", m_iStartBit, True))

            m_Properties.Properties.Add(New Crownwood.Magic.Controls.PropertySpec("Data Size", m_eDataSize.GetType(), "DataSize", _
                                        "Data Properties", "Determines the size of the data within the I/O array for this data item.", m_eDataSize))

            m_Properties.Properties.Add(New Crownwood.Magic.Controls.PropertySpec("Data Item", m_doDataItem.GetType(), "DataItem", _
            ...
            If m_bOutputEntry Then
                m_Properties.Properties.Add(New Crownwood.Magic.Controls.PropertySpec("Last Sent Item", m_doLastSentItem.GetType(), "LastSentItem", _
