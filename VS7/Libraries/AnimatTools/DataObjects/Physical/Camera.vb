...
#Region " Attributes "
        ...
        Protected m_thLinkedStructure As AnimatTools.TypeHelpers.LinkedStructureList
        Protected m_thLinkedPart As AnimatTools.TypeHelpers.LinkedBodyPartTree
...
#Region " Properties "
        ...
        Public Overridable Property TrackCamera() As Boolean
            ...
            Set(ByVal Value As Boolean)
                ...
                If Not Util.Application.ProjectWorkspace Is Nothing Then
                    Util.Application.ProjectWorkspace.ctrlProperties.Refresh()
                End If
        ...
        <Browsable(False)> _
        Public Overridable Property LinkedStructure() As AnimatTools.TypeHelpers.LinkedStructureList
            Get
                Return m_thLinkedStructure
            End Get
            Set(ByVal Value As AnimatTools.TypeHelpers.LinkedStructureList)
        ...
        <Browsable(False)> _
        Public Overridable Property LinkedPart() As AnimatTools.TypeHelpers.LinkedBodyPartTree
            Get
                Return m_thLinkedPart
            End Get
            Set(ByVal Value As AnimatTools.TypeHelpers.LinkedBodyPartTree)
        ...
        <Browsable(False)> _
        Public Overridable Property RecordFrameTime() As AnimatTools.Framework.ScaledNumber
            Get
        ...
        <Browsable(False)> _
        Public Overridable Property PlaybackFrameTime() As AnimatTools.Framework.ScaledNumber
            Get
        ...
        <Browsable(False)> _
        Public Overridable Property VideoStartTime() As AnimatTools.Framework.ScaledNumber
            Get
        ...
        <Browsable(False)> _
        Public Overridable Property VideoEndTime() As AnimatTools.Framework.ScaledNumber
            Get
...
#Region " Methods "
        ...
        Public Sub New(ByVal doParent As Framework.DataObject)
            MyBase.New(doParent)
            m_thLinkedStructure = New AnimatTools.TypeHelpers.LinkedStructureList(Nothing, TypeHelpers.LinkedStructureList.enumStructureType.All)
            m_thLinkedPart = New AnimatTools.TypeHelpers.LinkedBodyPartTree(Nothing, Nothing, GetType(DataObjects.Physical.BodyPart))
            ...
            m_snRecordFrameTime = New AnimatTools.Framework.ScaledNumber(Me, "RecordFrameTime", 1, AnimatTools.Framework.ScaledNumber.enumNumericScale.milli, "seconds", "s")
            m_snPlaybackFrameTime = New AnimatTools.Framework.ScaledNumber(Me, "PlaybackFrameTime", 100, AnimatTools.Framework.ScaledNumber.enumNumericScale.milli, "seconds", "s")
            m_snVideoStartTime = New AnimatTools.Framework.ScaledNumber(Me, "VideoStartTime", 0, AnimatTools.Framework.ScaledNumber.enumNumericScale.None, "seconds", "s")
            m_snVideoEndTime = New AnimatTools.Framework.ScaledNumber(Me, "VideoEndTime", 1, AnimatTools.Framework.ScaledNumber.enumNumericScale.None, "seconds", "s")
        ...
        Public Overridable Sub CreateWorkspaceTreeView(ByVal dsSim As AnimatTools.DataObjects.Simulation, _
            ...
            m_nodeCamera = Util.Environment.EnvironmentTreeNode.Nodes.Add("Camera")
            m_nodeCamera.ImageIndex = frmWorkspace.ImageManager.GetImageIndex("AnimatTools.CameraTreeView.gif")
            m_nodeCamera.SelectedImageIndex = frmWorkspace.ImageManager.GetImageIndex("AnimatTools.CameraTreeView.gif")
            m_nodeCamera.Tag = Me

        End Sub

        Public Overridable Sub AutoTrack(ByVal doStruct As AnimatTools.DataObjects.Physical.PhysicalStructure)
        ...
        Protected Overridable Sub SetCameraTracking()
            If Not Util.Application.SimulationView Is Nothing AndAlso Not Util.Application.SimulationView.Simulator Is Nothing _
               AndAlso Util.Application.SimulationView.Simulator.Loaded Then
                ...
                Util.Application.SimulationView.Simulator.TrackCamera(m_bTrackCamera, strStructID, strBodyID)
            End If
        End Sub

        Protected Overrides Sub BuildProperties()

            Dim pbNumberBag As Crownwood.Magic.Controls.PropertyBag = m_snRotation.Properties
            m_Properties.Properties.Add(New Crownwood.Magic.Controls.PropertySpec("Rotation", pbNumberBag.GetType(), "RotationScaled", _
            ...
            m_Properties.Properties.Add(New Crownwood.Magic.Controls.PropertySpec("Elevation", pbNumberBag.GetType(), "ElevationScaled", _
            ...
            m_Properties.Properties.Add(New Crownwood.Magic.Controls.PropertySpec("TrackCamera", m_bTrackCamera.GetType(), "TrackCamera", _
                                        "Camera Properties", "Determines whether or not the camera will track a user specified structure.", m_bTrackCamera))

            m_Properties.Properties.Add(New Crownwood.Magic.Controls.PropertySpec("Structure", GetType(AnimatTools.TypeHelpers.LinkedStructureList), "LinkedStructure", _
                                        "Camera Properties", "Determines which structure the camera will follow during the simulation.", _
                                        m_thLinkedStructure, GetType(AnimatTools.TypeHelpers.DropDownListEditor), GetType(AnimatTools.TypeHelpers.LinkedStructureTypeConverter)))

            m_Properties.Properties.Add(New Crownwood.Magic.Controls.PropertySpec("Structure Part", GetType(AnimatTools.TypeHelpers.LinkedBodyPartTree), "LinkedPart", _
            ...
            m_Properties.Properties.Add(New Crownwood.Magic.Controls.PropertySpec("RecordVideo", m_bRecordVideo.GetType(), "RecordVideo", _
                                        "Video Properties", "Determines whether or not the camera records video of the simulation.", m_bRecordVideo))

            m_Properties.Properties.Add(New Crownwood.Magic.Controls.PropertySpec("Save Frame Images", m_bRecordVideo.GetType(), "SaveFrameImages", _
            ...
            m_Properties.Properties.Add(New Crownwood.Magic.Controls.PropertySpec("Video File Name", m_strVideoFilename.GetType(), "VideoFilename", _
                                        "Video Properties", "The name of the video file to create.", m_strVideoFilename))

            m_Properties.Properties.Add(New Crownwood.Magic.Controls.PropertySpec("Video Width", m_iVideoWidth.GetType(), "VideoWidth", _
                                        "Video Properties", "The width of the resolution of the video.", m_iVideoWidth))

            m_Properties.Properties.Add(New Crownwood.Magic.Controls.PropertySpec("Video Height", m_iVideoHeight.GetType(), "VideoHeight", _
                                        "Video Properties", "The height of the resolution of the video.", m_iVideoHeight))

            pbNumberBag = m_snRecordFrameTime.Properties
            m_Properties.Properties.Add(New Crownwood.Magic.Controls.PropertySpec("Record Frame Time", pbNumberBag.GetType(), "RecordFrameTime", _
            ...
            m_Properties.Properties.Add(New Crownwood.Magic.Controls.PropertySpec("Playback Frame Time", pbNumberBag.GetType(), "PlaybackFrameTime", _
            ...
            m_Properties.Properties.Add(New Crownwood.Magic.Controls.PropertySpec("Video Start Time", pbNumberBag.GetType(), "VideoStartTime", _
                                        "Video Properties", "The simulation time to begin recording video.", pbNumberBag, _
                                        "", GetType(AnimatTools.Framework.ScaledNumber.ScaledNumericPropBagConverter)))

            pbNumberBag = m_snVideoEndTime.Properties
            m_Properties.Properties.Add(New Crownwood.Magic.Controls.PropertySpec("Video End Time", pbNumberBag.GetType(), "VideoEndTime", _
                                        "Video Properties", "The simulation time to end recording video.", pbNumberBag, _
                                        "", GetType(AnimatTools.Framework.ScaledNumber.ScaledNumericPropBagConverter)))

            m_Properties.Properties.Add(New Crownwood.Magic.Controls.PropertySpec("Compression", m_strVideoCompression.GetType(), "VideoCompression", _
                                        "Video Properties", "Sets the compression to use for the video.", m_strVideoCompression, _
                                        GetType(AnimatTools.TypeHelpers.CompressionTypeEditor)))
        ...
        Public Overridable Overloads Sub SaveData(ByRef dsSim As Simulation, ByRef oXml As Interfaces.StdXml)
            ...
            Else
                oXml.AddChildElement("RecordVideo", False)
            End If
