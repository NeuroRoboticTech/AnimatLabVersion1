...
Namespace TypeHelpers
    ...
    Public Class GainTypeEditor
        ...
        Public Overloads Overrides Function EditValue(ByVal context As ITypeDescriptorContext, ByVal provider As IServiceProvider, ByVal value As Object) As Object
            Dim frmGainEditor As New AnimatTools.Forms.Gain.EditGain
            ...
            Try
                ...
                If (Not context Is Nothing And Not context.Instance Is Nothing And Not provider Is Nothing) Then
                    ...
                    If (Not service Is Nothing) AndAlso ((TypeOf (value) Is AnimatTools.DataObjects.Gain) OrElse value Is Nothing) Then
                        Dim oGain As AnimatTools.DataObjects.Gain
                        If Not value Is Nothing Then
                            oGain = DirectCast(value, AnimatTools.DataObjects.Gain)
                        Else
                            oGain = New AnimatTools.DataObjects.Gains.Polynomial(Nothing, "Gain", "Input Variable", "Output Variable", False, False)
                        End If
