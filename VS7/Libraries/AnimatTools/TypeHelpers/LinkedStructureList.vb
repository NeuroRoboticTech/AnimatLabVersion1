...
#Region " Methods "
        ...
        Protected Sub AddItemsToList(ByRef lbList As ListBox, ByVal aryItems As Collections.SortedStructures, _
                                     ByRef lbSelectedItem As AnimatTools.TypeHelpers.DropDownEntry)

            For Each deItem As DictionaryEntry In aryItems
                Dim doStructure As AnimatTools.DataObjects.Physical.PhysicalStructure = DirectCast(deItem.Value, AnimatTools.DataObjects.Physical.PhysicalStructure)

                Dim thItem As LinkedStructureList = New LinkedStructureList(doStructure, m_eStructureType)
                Dim leItem As New AnimatTools.TypeHelpers.DropDownEntry(doStructure.Name, thItem)
