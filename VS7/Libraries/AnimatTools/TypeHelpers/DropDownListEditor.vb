...
Namespace TypeHelpers
    ...
    Public Class DropDownListEditor
        ...
        Public Overloads Overrides Function EditValue(ByVal context As ITypeDescriptorContext, _
            ...
            If value Is Nothing OrElse Not TypeOf (value) Is AnimatTools.Framework.DataObject Then
                Return MyBase.EditValue(provider, value)
            End If
            Dim doValue As AnimatTools.Framework.DataObject = DirectCast(value, AnimatTools.Framework.DataObject)
            ...
            If Not lst.SelectedItem Is Nothing Then
                Dim leEntry As AnimatTools.TypeHelpers.DropDownEntry = DirectCast(lst.SelectedItem, AnimatTools.TypeHelpers.DropDownEntry)
                value = leEntry.Value
            End If
