...
Namespace TypeHelpers
    ...
    Public Class CollisionPairsTypeEditor
        ...
        Public Overloads Overrides Function EditValue(ByVal context As ITypeDescriptorContext, ByVal provider As IServiceProvider, ByVal value As Object) As Object
            Dim frmPairEditor As New AnimatTools.Forms.BodyPlan.EditCollisionPairs
            ...
            Try
                ...
                If (Not context Is Nothing And Not context.Instance Is Nothing And Not provider Is Nothing) Then
                    ...
                    If (Not service Is Nothing) AndAlso ((TypeOf (value) Is AnimatTools.Collections.CollisionPairs) OrElse value Is Nothing) Then
                        Dim aryPairs As AnimatTools.Collections.CollisionPairs
                        If Not value Is Nothing Then
                            aryPairs = DirectCast(value, AnimatTools.Collections.CollisionPairs)
                        Else
                            'It should never pass us in a null reference. If it does then something is screwed up.
                            Return Nothing
                        End If

                        frmPairEditor.CollisionPairs = DirectCast(aryPairs.Clone(aryPairs.Parent, False, Nothing), AnimatTools.Collections.CollisionPairs)
