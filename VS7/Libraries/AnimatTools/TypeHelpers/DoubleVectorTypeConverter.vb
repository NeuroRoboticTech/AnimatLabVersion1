...
Namespace TypeHelpers
    ...
    Public Class Vec3dTypeConverter
        ...
        Public Overloads Overrides Function CanConvertTo(ByVal context As System.ComponentModel.ITypeDescriptorContext, ByVal destinationType As System.Type) As Boolean
            ...
            If Util.IsTypeOf(destinationType, GetType(AnimatTools.Framework.Vec3d)) Then
                Return True
            End If
        ...
        Public Overloads Overrides Function ConvertTo(ByVal context As System.ComponentModel.ITypeDescriptorContext, ByVal culture As System.Globalization.CultureInfo, ByVal value As Object, ByVal destinationType As System.Type) As Object
            ...
            If Not value Is Nothing AndAlso Util.IsTypeOf(value.GetType, GetType(AnimatTools.Framework.Vec3d), False) Then
                Dim fwVector As AnimatTools.Framework.Vec3d = DirectCast(value, AnimatTools.Framework.Vec3d)
