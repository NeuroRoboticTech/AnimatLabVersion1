...
namespace AnimatTools
{
	namespace Interfaces
	{
		...
		System::String *StdXml::Serialize()
		{
			try
			{
				return m_lpXml->Serialize().c_str();
			}
			catch(CStdErrorInfo oError)
			{
				throw new Exception(oError.m_strError.c_str());
				return NULL;
			}
		}
		...
		System::String *StdXml::FullTagPath(bool bAddChildName)
		{
			try
			{
				return m_lpXml->FullTagPath(bAddChildName).c_str();
			}
			catch(CStdErrorInfo oError)
			{
				throw new Exception(oError.m_strError.c_str());
		...
		System::String *StdXml::GetChildString(System::String *strElementName)
		{
			try
			{
				return m_lpXml->GetChildString(Util::StringToStd(strElementName)).c_str();
			}
			catch(CStdErrorInfo oError)
			{
				throw new Exception(oError.m_strError.c_str());
		...
		System::String *StdXml::GetChildString(System::String *strElementName, System::String *strDefault)
		{
			try
			{
				return m_lpXml->GetChildString(Util::StringToStd(strElementName), Util::StringToStd(strDefault)).c_str();
			}
			catch(CStdErrorInfo oError)
			{
				throw new Exception(oError.m_strError.c_str());
		...
		System::String *StdXml::GetChildString()
		{
			try
			{
				return m_lpXml->GetChildString().c_str();
			}
			catch(CStdErrorInfo oError)
			{
				throw new Exception(oError.m_strError.c_str());
		...
		System::Byte StdXml::GetChildByteArray(System::String *strElementName)[]
		{
			...
			try
			{
				...
				else
				{
					...
					System::Byte aryData[] = new System::Byte[lByteCount];
					long lIndex;
		...
		void StdXml::AddChildElement(System::String *strElementName, System::Byte aryData[])
		{
		...
		System::String *StdXml::GetAttribString(System::String *strAttribName, bool bCanBeBlank, bool bThrowError, System::String *strDefault)
		{
			try
			{
				return m_lpXml->GetAttribString(Util::StringToStd(strAttribName), bCanBeBlank, bThrowError, Util::StringToStd(strDefault)).c_str();
			}
			catch(CStdErrorInfo oError)
			{
				throw new Exception(oError.m_strError.c_str());
		...
		System::String *StdXml::GetChildAttribString(System::String *strAttribName, bool bCanBeBlank, bool bThrowError, System::String *strDefault)
		{
			try
			{
				return m_lpXml->GetChildAttribString(Util::StringToStd(strAttribName), bCanBeBlank, bThrowError, Util::StringToStd(strDefault)).c_str();
			}
			catch(CStdErrorInfo oError)
			{
				throw new Exception(oError.m_strError.c_str());
		...
		System::String *StdXml::GetChildDoc()
		{
			try
			{
				...
				System::String *strVal = strDoc.c_str();
				return strVal;
			}
			catch(CStdErrorInfo oError)
			{
		...
		System::String *StdXml::GetParentTagName()
		{
			try
			{
				return m_lpXml->GetParentTagName().c_str();
			}
			catch(CStdErrorInfo oError)
			{
				throw new Exception(oError.m_strError.c_str());
